...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.26519289e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.70004050e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03936433e+01   # MW
        25     1.15484642e+02   # h0
        35     7.79898613e+02   # H0
        36     7.80035391e+02   # A0
        37     7.84305596e+02   # H+
   1000021     8.76446715e+02   # ~g
   1000022     1.44921488e+02   # ~neutralino(1)
   1000023     2.76971265e+02   # ~neutralino(2)
   1000024     2.77055512e+02   # ~chargino(1)
   1000025    -5.23710280e+02   # ~neutralino(3)
   1000035     5.34271463e+02   # ~neutralino(4)
   1000037     5.35754042e+02   # ~chargino(2)
   1000001     1.23232334e+03   # ~d_L
   1000002     1.22987714e+03   # ~u_L
   1000003     1.23227863e+03   # ~s_L
   1000004     1.22983235e+03   # ~c_L
   1000005     9.55133977e+02   # ~b_1
   1000006     7.84127432e+02   # ~t_1
   ...
   1000016     9.36229232e+02   # ~nu_tau_L
   ...
   2000006     9.92636213e+02   # ~t_2
   2000011     1.00826955e+03   # ~e_R
   2000013     1.00773999e+03   # ~mu_R
   2000015     9.43666000e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -2.60337741e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.94739404e-01   # N_{1,1}
  1  2    -1.79052765e-02   # N_{1,2}
  1  3     9.64551697e-02   # N_{1,3}
  1  4    -2.94842173e-02   # N_{1,4}
  2  1     4.06571133e-02   # N_{2,1}
  2  2     9.71542240e-01   # N_{2,2}
  2  3    -2.04700657e-01   # N_{2,3}
  2  4     1.12028194e-01   # N_{2,4}
  3  1    -4.57428843e-02   # N_{3,1}
  3  2     6.78983432e-02   # N_{3,2}
  3  3     7.00927594e-01   # N_{3,3}
  3  4     7.08518110e-01   # N_{3,4}
  4  1    -8.21468528e-02   # N_{4,1}
  4  2     2.26218682e-01   # N_{4,2}
  4  3     6.76383434e-01   # N_{4,3}
  4  4    -6.96119568e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.56305222e-01   # U_{1,1}
  1  2    -2.92370182e-01   # U_{1,2}
  2  1     2.92370182e-01   # U_{2,1}
  2  2     9.56305222e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.87025097e-01   # V_{1,1}
  1  2    -1.60566052e-01   # V_{1,2}
  2  1     1.60566052e-01   # V_{2,1}
...
Block ae Q= 8.61227778e+02  
  1  1    -5.52810153e+02      # Ae(Q)MSSM DRbar
  2  2    -5.52517893e+02      # Amu(Q)MSSM DRbar
