...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.61733587e-05
...
# PDG code     mass             particle
   ...
   1000037     3.48282747e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -8.09364540e-02   # N_{1,2}
  1  3     2.47863404e-01   # N_{1,3}
  1  4    -1.39399129e-01   # N_{1,4}
  2  1    -2.62569226e-01   # N_{2,1}
  2  2    -6.53313844e-01   # N_{2,2}
  2  3     5.37962758e-01   # N_{2,3}
  2  4    -4.63502420e-01   # N_{2,4}
  3  1    -6.79291116e-02   # N_{3,1}
  3  2     9.21950343e-02   # N_{3,2}
  3  3     6.92496108e-01   # N_{3,3}
  3  4     7.12274421e-01   # N_{3,4}
  4  1    -1.17737552e-01   # N_{4,1}
  4  2     7.47081245e-01   # N_{4,2}
  4  3     4.11836064e-01   # N_{4,3}
  4  4    -5.08329163e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -5.81561880e-01   # U_{1,1}
  1  2     8.13502169e-01   # U_{1,2}
  2  1    -8.13502169e-01   # U_{2,1}
  2  2    -5.81561880e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -7.19859425e-01   # V_{1,1}
  1  2     6.94119880e-01   # V_{1,2}
  2  1    -6.94119880e-01   # V_{2,1}
  2  2    -7.19859425e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     5.99488658e-01   # F_{11}
  1  2     8.00383251e-01   # F_{12}
  2  1     8.00383251e-01   # F_{21}
  2  2    -5.99488658e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.73858839e-01   # F_{11}
  1  2     9.84770585e-01   # F_{12}
  2  1     9.84770585e-01   # F_{21}
  2  2    -1.73858839e-01   # F_{22}
Block gauge Q= 7.29474231e+02  # SM gauge couplings
     1     3.62409658e-01   # g'(Q)MSSM DRbar
     2     6.45744588e-01   # g(Q)MSSM DRbar
...
Block msoft Q= 7.29474231e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     2.86912203e+02      # M_2(Q)
     3     7.98376682e+02      # M_3(Q)
    21     4.26438160e+04      # mH1^2(Q)
    22    -6.75544109e+04      # mH2^2(Q)
...
Block au Q= 7.29474231e+02  
  1  1    -2.43801935e+02      # Au(Q)MSSM DRbar
...
Block ae Q= 7.29474231e+02  
  ...
  2  2    -2.38597342e+01      # Amu(Q)MSSM DRbar
  3  3    -2.38063695e+01      # Atau(Q)MSSM DRbar
