...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.79840919e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.97833164e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03886366e+01   # MW
        25     1.18446743e+02   # h0
        35     8.65272589e+02   # H0
        36     8.65264760e+02   # A0
        37     8.69290791e+02   # H+
   1000021     1.49024605e+03   # ~g
   1000022     2.73950090e+02   # ~neutralino(1)
   1000023     5.21375652e+02   # ~neutralino(2)
   1000024     5.21515288e+02   # ~chargino(1)
   1000025    -8.51062189e+02   # ~neutralino(3)
   1000035     8.59250486e+02   # ~neutralino(4)
   1000037     8.60103388e+02   # ~chargino(2)
   1000001     1.52213618e+03   # ~d_L
   1000002     1.52020992e+03   # ~u_L
   1000003     1.52209263e+03   # ~s_L
   1000004     1.52016630e+03   # ~c_L
   1000005     1.27098639e+03   # ~b_1
   1000006     1.08717131e+03   # ~t_1
   1000011     8.65185308e+02   # ~e_L
   1000012     8.61213863e+02   # ~nue_L
   1000013     8.64977236e+02   # ~mu_L
   1000014     8.61006530e+02   # ~numu_L
   1000015     6.09215053e+02   # ~stau_1
   1000016     7.89894860e+02   # ~nu_tau_L
   2000001     1.47304583e+03   # ~d_R
   2000002     1.47720363e+03   # ~u_R
   2000003     1.47296017e+03   # ~s_R
   2000004     1.47719803e+03   # ~c_R
   2000005     1.34731013e+03   # ~b_2
   2000006     1.31986897e+03   # ~t_2
   2000011     7.88645473e+02   # ~e_R
   2000013     7.88188423e+02   # ~mu_R
   2000015     8.03985856e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -2.59197922e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.97966685e-01   # N_{1,1}
  1  2    -7.00756454e-03   # N_{1,2}
  1  3     5.98012966e-02   # N_{1,3}
  1  4    -2.09091964e-02   # N_{1,4}
  2  1     1.75995562e-02   # N_{2,1}
  2  2     9.84843526e-01   # N_{2,2}
  2  3    -1.46321838e-01   # N_{2,3}
  2  4     9.14516515e-02   # N_{2,4}
  3  1    -2.71357298e-02   # N_{3,1}
  3  2     3.95011763e-02   # N_{3,2}
  3  3     7.04907075e-01   # N_{3,3}
  3  4     7.07678829e-01   # N_{3,4}
  4  1    -5.49217927e-02   # N_{4,1}
  4  2     1.68741756e-01   # N_{4,2}
  4  3     6.91462031e-01   # N_{4,3}
  4  4    -7.00278570e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.78024771e-01   # U_{1,1}
  1  2    -2.08488721e-01   # U_{1,2}
  2  1     2.08488721e-01   # U_{2,1}
  2  2     9.78024771e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91406572e-01   # V_{1,1}
  1  2    -1.30816697e-01   # V_{1,2}
  2  1     1.30816697e-01   # V_{2,1}
  2  2     9.91406572e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.67724513e-01   # F_{11}
  1  2     9.29934773e-01   # F_{12}
  2  1     9.29934773e-01   # F_{21}
  2  2    -3.67724513e-01   # F_{22}
...
Block gauge Q= 1.16443043e+03  # SM gauge couplings
     ...
     2     6.40749661e-01   # g(Q)MSSM DRbar
...
Block msoft Q= 1.16443043e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21     4.46850711e+04      # mH1^2(Q)
    22    -6.99015958e+05      # mH2^2(Q)
...
Block au Q= 1.16443043e+03  
  1  1    -1.78111536e+03      # Au(Q)MSSM DRbar
  2  2    -1.78107370e+03      # Ac(Q)MSSM DRbar
  3  3    -1.25136020e+03      # At(Q)MSSM DRbar
Block ad Q= 1.16443043e+03  
  1  1    -2.05354984e+03      # Ad(Q)MSSM DRbar
  2  2    -2.05344377e+03      # As(Q)MSSM DRbar
  3  3    -1.73151972e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.16443043e+03  
  1  1    -6.82580291e+02      # Ae(Q)MSSM DRbar
  2  2    -6.82247878e+02      # Amu(Q)MSSM DRbar
  3  3    -5.72739850e+02      # Atau(Q)MSSM DRbar
