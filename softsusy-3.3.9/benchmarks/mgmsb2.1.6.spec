...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.00755189e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04003150e+01   # MW
   ...
   1000011     4.10082912e+02   # ~e_L
   1000012     4.02048239e+02   # ~nue_L
   ...
   2000013     2.04118550e+02   # ~mu_R
   2000015     4.10686131e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -7.33553998e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.89891548e-01   # N_{1,1}
  1  2    -2.78710847e-02   # N_{1,2}
  1  3     1.25575490e-01   # N_{1,3}
  1  4    -5.97387782e-02   # N_{1,4}
  2  1     8.98178238e-02   # N_{2,1}
  2  2     8.74540383e-01   # N_{2,2}
  2  3    -3.72529349e-01   # N_{2,3}
  2  4     2.97209962e-01   # N_{2,4}
  3  1    -4.43922545e-02   # N_{3,1}
  3  2     6.22261303e-02   # N_{3,2}
  3  3     7.01039927e-01   # N_{3,3}
  3  4     7.09013581e-01   # N_{3,4}
  4  1    -1.00383310e-01   # N_{4,1}
  4  2     4.80135637e-01   # N_{4,2}
  4  3     5.94975379e-01   # N_{4,3}
  4  4    -6.36708143e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.42108775e-01   # U_{1,1}
  1  2    -5.39307715e-01   # U_{1,2}
  2  1     5.39307715e-01   # U_{2,1}
  2  2     8.42108775e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02315881e-01   # V_{1,1}
  1  2    -4.31075458e-01   # V_{1,2}
  2  1     4.31075458e-01   # V_{2,1}
  2  2     9.02315881e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.24838942e-01   # F_{11}
  1  2     9.74395941e-01   # F_{12}
  2  1     9.74395941e-01   # F_{21}
  2  2    -2.24838942e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.78500611e-01   # F_{11}
  1  2     9.25601041e-01   # F_{12}
  2  1     9.25601041e-01   # F_{21}
  2  2    -3.78500611e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     9.31207243e-02   # F_{11}
  1  2     9.95654825e-01   # F_{12}
  2  1     9.95654825e-01   # F_{21}
  2  2    -9.31207243e-02   # F_{22}
Block gauge Q= 1.18855474e+03  # SM gauge couplings
     1     3.63446809e-01   # g'(Q)MSSM DRbar
     2     6.43604186e-01   # g(Q)MSSM DRbar
...
Block msoft Q= 1.18855474e+03  # MSSM DRbar SUSY breaking parameters
     ...
     2     3.70806091e+02      # M_2(Q)
     3     9.97189124e+02      # M_3(Q)
    21     1.43192808e+05      # mH1^2(Q)
    22    -1.75188849e+05      # mH2^2(Q)
    31     4.03313586e+02      # meL(Q)
    32     4.03311783e+02      # mmuL(Q)
    33     4.02759595e+02      # mtauL(Q)
...
Block ae Q= 1.18855474e+03  
  1  1    -3.17676989e+01      # Ae(Q)MSSM DRbar
  2  2    -3.17674643e+01      # Amu(Q)MSSM DRbar
  3  3    -3.16956594e+01      # Atau(Q)MSSM DRbar
