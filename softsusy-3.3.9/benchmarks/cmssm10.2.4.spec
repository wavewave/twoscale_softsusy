...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.75165642e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.44820849e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03935565e+01   # MW
        25     1.16617574e+02   # h0
        35     9.38838577e+02   # H0
        36     9.38616621e+02   # A0
        37     9.42287255e+02   # H+
   1000021     1.46434854e+03   # ~g
   1000022     2.70023778e+02   # ~neutralino(1)
   1000023     5.10928673e+02   # ~neutralino(2)
   1000024     5.11007916e+02   # ~chargino(1)
   1000025    -7.99937676e+02   # ~neutralino(3)
   1000035     8.11872172e+02   # ~neutralino(4)
   1000037     8.12085028e+02   # ~chargino(2)
   ...
   1000013     5.16392156e+02   # ~mu_L
   1000014     5.10120152e+02   # ~numu_L
   1000015     3.62826929e+02   # ~stau_1
   1000016     5.08384224e+02   # ~nu_tau_L
   2000001     1.30193773e+03   # ~d_R
   2000002     1.30684069e+03   # ~u_R
   2000003     1.30193425e+03   # ~s_R
   2000004     1.30683709e+03   # ~c_R
   2000005     1.29649904e+03   # ~b_2
   2000006     1.27877714e+03   # ~t_2
   2000011     3.69700307e+02   # ~e_R
   2000013     3.69685918e+02   # ~mu_R
   2000015     5.16211126e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -1.05586764e-01       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.97351445e-01   # N_{1,1}
  1  2    -1.10231901e-02   # N_{1,2}
  1  3     6.60488188e-02   # N_{1,3}
  1  4    -2.83925661e-02   # N_{1,4}
  2  1     2.53837586e-02   # N_{2,1}
  2  2     9.78161788e-01   # N_{2,2}
  2  3    -1.69516218e-01   # N_{2,3}
  2  4     1.17556088e-01   # N_{2,4}
  3  1    -2.61092740e-02   # N_{3,1}
  3  2     3.77565496e-02   # N_{3,2}
  3  3     7.04850439e-01   # N_{3,3}
  3  4     7.07869061e-01   # N_{3,4}
  4  1    -6.29608260e-02   # N_{4,1}
  4  2     2.04089317e-01   # N_{4,2}
  4  3     6.85629393e-01   # N_{4,3}
  4  4    -6.95913659e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.70260255e-01   # U_{1,1}
  1  2    -2.42064118e-01   # U_{1,2}
  2  1     2.42064118e-01   # U_{2,1}
  2  2     9.70260255e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.85720794e-01   # V_{1,1}
  1  2    -1.68387995e-01   # V_{1,2}
  2  1     1.68387995e-01   # V_{2,1}
  2  2     9.85720794e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.57321597e-01   # F_{11}
  1  2     9.33981411e-01   # F_{12}
  2  1     9.33981411e-01   # F_{21}
  2  2    -3.57321597e-01   # F_{22}
...
Block ad Q= 1.12132656e+03  
  ...
  2  2    -1.75935732e+03      # As(Q)MSSM DRbar
