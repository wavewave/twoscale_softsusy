...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.81392354e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.77333515e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03898648e+01   # MW
        25     1.17476646e+02   # h0
        35     6.59482560e+02   # H0
        36     6.59487659e+02   # A0
        37     6.64708847e+02   # H+
   ...
   1000025    -7.56033197e+02   # ~neutralino(3)
   1000035     7.63934467e+02   # ~neutralino(4)
   1000037     7.65007574e+02   # ~chargino(2)
   1000001     1.19426778e+03   # ~d_L
   1000002     1.19173248e+03   # ~u_L
   1000003     1.19423289e+03   # ~s_L
   1000004     1.19169751e+03   # ~c_L
   1000005     9.98869292e+02   # ~b_1
   1000006     8.55784218e+02   # ~t_1
   1000011     5.06813456e+02   # ~e_L
   1000012     5.00297151e+02   # ~nue_L
   1000013     5.06675844e+02   # ~mu_L
   1000014     5.00158551e+02   # ~numu_L
   1000015     2.30312657e+02   # ~stau_1
   1000016     4.52843846e+02   # ~nu_tau_L
   2000001     1.14726409e+03   # ~d_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -8.89581748e-03   # N_{1,2}
  1  3     6.66744727e-02   # N_{1,3}
  1  4    -2.21244134e-02   # N_{1,4}
  2  1     2.11230629e-02   # N_{2,1}
  2  2     9.83534648e-01   # N_{2,2}
  2  3    -1.54453021e-01   # N_{2,3}
  2  4     9.14203350e-02   # N_{2,4}
  3  1    -3.09652222e-02   # N_{3,1}
  3  2     4.54572522e-02   # N_{3,2}
  3  3     7.04209853e-01   # N_{3,3}
  3  4     7.07858232e-01   # N_{3,4}
  4  1    -6.00756338e-02   # N_{4,1}
  4  2     1.74682854e-01   # N_{4,2}
  4  3     6.89773341e-01   # N_{4,3}
  4  4    -7.00063966e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.75522996e-01   # U_{1,1}
  1  2    -2.19897442e-01   # U_{1,2}
  2  1     2.19897442e-01   # U_{2,1}
  2  2     9.75522996e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91433764e-01   # V_{1,1}
  1  2    -1.30610459e-01   # V_{1,2}
  2  1     1.30610459e-01   # V_{2,1}
...
Block gauge Q= 9.30213836e+02  # SM gauge couplings
     1     3.62334629e-01   # g'(Q)MSSM DRbar
     2     6.41902530e-01   # g(Q)MSSM DRbar
     3     1.05658763e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.30213836e+02  
  3  3     8.53303813e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.30213836e+02  
  3  3     4.90760239e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.30213836e+02  
  3  3     4.27547451e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.30213836e+02 # Higgs mixing parameters
     1     7.52810824e+02    # mu(Q)MSSM DRbar
     2     3.92129603e+01    # tan beta(Q)MSSM DRbar
     3     2.43913997e+02    # higgs vev(Q)MSSM DRbar
     4     5.49709577e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.30213836e+02  # MSSM DRbar SUSY breaking parameters
     1     2.32434303e+02      # M_1(Q)
     2     4.30638438e+02      # M_2(Q)
     3     1.22095051e+03      # M_3(Q)
    21    -1.31761947e+05      # mH1^2(Q)
    22    -5.58041561e+05      # mH2^2(Q)
