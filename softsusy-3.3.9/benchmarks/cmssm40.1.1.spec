...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.87272955e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.06050606e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03906350e+01   # MW
        25     1.16994003e+02   # h0
        35     6.09530563e+02   # H0
        36     6.09544964e+02   # A0
        37     6.15189475e+02   # H+
   1000021     1.15306201e+03   # ~g
   1000022     2.07041723e+02   # ~neutralino(1)
   1000023     3.94704134e+02   # ~neutralino(2)
   1000024     3.94831137e+02   # ~chargino(1)
   1000025    -7.02935576e+02   # ~neutralino(3)
   1000035     7.10982327e+02   # ~neutralino(4)
   1000037     7.12167466e+02   # ~chargino(2)
   1000001     1.09880081e+03   # ~d_L
   1000002     1.09603227e+03   # ~u_L
   1000003     1.09876751e+03   # ~s_L
   1000004     1.09599887e+03   # ~c_L
   1000005     9.12840719e+02   # ~b_1
   1000006     7.76574398e+02   # ~t_1
   ...
   2000004     1.05951339e+03   # ~c_R
   2000005     9.81128043e+02   # ~b_2
   2000006     9.89135947e+02   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.02798534e-02   # N_{1,2}
  1  3     7.15315790e-02   # N_{1,3}
  1  4    -2.31889944e-02   # N_{1,4}
  2  1     2.39145548e-02   # N_{2,1}
  2  2     9.82071750e-01   # N_{2,2}
  2  3    -1.61891646e-01   # N_{2,3}
  2  4     9.35642387e-02   # N_{2,4}
  3  1    -3.35091215e-02   # N_{3,1}
  3  2     4.93692654e-02   # N_{3,2}
  3  3     7.03707665e-01   # N_{3,3}
  3  4     7.07979758e-01   # N_{3,4}
  4  1    -6.37605245e-02   # N_{4,1}
  4  2     1.81637215e-01   # N_{4,2}
  4  3     6.88091455e-01   # N_{4,3}
  4  4    -6.99623232e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.73057295e-01   # U_{1,1}
  1  2    -2.30563443e-01   # U_{1,2}
  2  1     2.30563443e-01   # U_{2,1}
  2  2     9.73057295e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91018496e-01   # V_{1,1}
  1  2    -1.33724870e-01   # V_{1,2}
  2  1     1.33724870e-01   # V_{2,1}
...
Block staumix               # stau mixing matrix
  1  1     3.55674694e-01   # F_{11}
  1  2     9.34609818e-01   # F_{12}
  2  1     9.34609818e-01   # F_{21}
  2  2    -3.55674694e-01   # F_{22}
Block gauge Q= 8.50961708e+02  # SM gauge couplings
     1     3.62132828e-01   # g'(Q)MSSM DRbar
     2     6.42336608e-01   # g(Q)MSSM DRbar
     3     1.06123658e+00   # g3(Q)MSSM DRbar
Block yu Q= 8.50961708e+02  
  3  3     8.56328251e-01   # Yt(Q)MSSM DRbar
Block yd Q= 8.50961708e+02  
  3  3     4.91160240e-01   # Yb(Q)MSSM DRbar
Block ye Q= 8.50961708e+02  
  3  3     4.27332018e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 8.50961708e+02 # Higgs mixing parameters
     1     6.99525201e+02    # mu(Q)MSSM DRbar
     2     3.92347808e+01    # tan beta(Q)MSSM DRbar
     3     2.44017896e+02    # higgs vev(Q)MSSM DRbar
     4     4.69190667e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 8.50961708e+02  # MSSM DRbar SUSY breaking parameters
     1     2.10482988e+02      # M_1(Q)
     2     3.90867401e+02      # M_2(Q)
     3     1.11771426e+03      # M_3(Q)
    21    -1.16846947e+05      # mH1^2(Q)
    22    -4.83190972e+05      # mH2^2(Q)
