...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.05569712e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.56093257e-04
...
# PDG code     mass             particle
   ...
   1000023     3.93581058e+02   # ~neutralino(2)
   1000024     3.93580635e+02   # ~chargino(1)
   1000025    -6.31593102e+02   # ~neutralino(3)
   1000035     6.46483812e+02   # ~neutralino(4)
   1000037     6.46625027e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.74538131e-02   # N_{1,2}
  1  3     8.42361097e-02   # N_{1,3}
  1  4    -3.54977146e-02   # N_{1,4}
  2  1     3.93279325e-02   # N_{2,1}
  2  2     9.67844238e-01   # N_{2,2}
  2  3    -2.05409747e-01   # N_{2,3}
  2  4     1.39777253e-01   # N_{2,4}
  3  1    -3.34177497e-02   # N_{3,1}
  3  2     4.83726041e-02   # N_{3,2}
  3  3     7.03487405e-01   # N_{3,3}
  3  4     7.08271711e-01   # N_{3,4}
  4  1    -7.74403851e-02   # N_{4,1}
  4  2     2.46237663e-01   # N_{4,2}
  4  3     6.75141900e-01   # N_{4,3}
  4  4    -6.91052397e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.55549280e-01   # U_{1,1}
  1  2    -2.94831431e-01   # U_{1,2}
  2  1     2.94831431e-01   # U_{2,1}
  2  2     9.55549280e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.79492972e-01   # V_{1,1}
  1  2    -2.01478331e-01   # V_{1,2}
  2  1     2.01478331e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     4.15876085e-02   # F_{12}
  2  1    -4.15876085e-02   # F_{21}
...
Block hmix Q= 1.11563796e+03 # Higgs mixing parameters
     1     6.23971938e+02    # mu(Q)MSSM DRbar
...
Block au Q= 1.11563796e+03  
  ...
  3  3    -8.63683701e+02      # At(Q)MSSM DRbar
Block ad Q= 1.11563796e+03  
  1  1    -1.36814111e+03      # Ad(Q)MSSM DRbar
