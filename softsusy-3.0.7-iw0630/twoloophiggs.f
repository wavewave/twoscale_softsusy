...
*     
      ...
      double precision Pi/3.141592654/,Nc/1d0/ ! color factor !!!
...
c     shift of the parameters from DRbar to On-Shell scheme
      ...
      double precision Pi/3.141592654/,mt,ct2,st2,v2,v22,
     $     Nc/1d0/,colorfactor 
...
*
      ...
      implicit none
      double precision t,A0,BL,T1,T2,s2t,c2t,cb,sb,q,mu
      double precision Pi/3.141592654/,Xt,Yt
...
*
      ...
      double precision Pi/3.14159265897d0/,Nc/1d0/ ! color factor !!!
