...
public:
  ...
  */
  ...
  virtual void lesHouchesAccordOutput(ostream & out, char model[], 
				      ...
				      const QedQcd & twoset, 
				      bool altEwsb = false);
  /// This does the job of the above method, but performs the flavour
  /// independent bits
  void flavourIndependentSLHA(ostream & out, const char model[], 
			      const DoubleVector & pars, 
			      int sgnMu, double tanb, double qMax, 
			      int numPoints, 
			      double mgut, 
  ...
  /// This does the job of the above method, but performs the start
  /// and Higgs bits
  void headerHiggsSLHA(ostream & out, const char model[], 
			      const DoubleVector & pars, 
			      int sgnMu, double tanb, double qMax, 
  ...
  /// This does the job of the above method, but performs the flavour
  /// independent mixing bits
  void mixingSLHA(ostream & out, const char model[], 
			      const DoubleVector & pars, 
			      int sgnMu, double tanb, double qMax, 
			      int numPoints, double mgut, 
			      bool altEwsb = false);
