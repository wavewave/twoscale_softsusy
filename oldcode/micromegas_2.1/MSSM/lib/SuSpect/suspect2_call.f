...
c  =1:  warning/error messages in output file (recommended choice)
...
c   (see functions in the comments above) in the output file SuSpect.out
       DATA ichoice/0, 21, 1, 1, 1, 1, 2, 1, 2, 2, 0/
       character*100 argv
...
c                      
      ichoice(11) = 0
c ICHOICE(11): !NEW! higher order Higgs 'scheme' in rad. corr. at mZ:
