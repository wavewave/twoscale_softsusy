...
static double qMass[7]={0,0,0,0,1.357,4.329,166.};
...
int main(int n, char **args)
{
  ...
  sscanf(args[2],"%lf",&mbmb);
  sscanf(args[3],"%lf",&mtp);
  sscanf(args[4],"%lf",&Q);

  initQCD(alphaSMZ,McMc,mbmb,mtp);

printf("lambda 3 4 5 6= %f %f %f %f\n",lambda[3],lambda[4],lambda[5],lambda[6]);
