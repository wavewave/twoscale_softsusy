...
*-----------------------------------------------------------------------
      ...
      open(21, FILE='micromegas.in',STATUS='UNKNOWN')
...
* Higgs
       write(21,fmt='(A3,2x,1PE16.8)') 'MHc', SSPARA_H(2)

      do  I=1,3
        write(21,fmt='(A2,I1,2x,1PE16.8)') 'Mh', I,HMASS_H(I)  
      enddo  

      do I=1,3
      do J=1,3 
        write(21,fmt='(A2,I1,I1,2x,1PE16.8)') 'Zh', I,J,OMIX_H(I,J)
      enddo
      enddo
* sTop
      do  I=1,2
        write(21,fmt='(A3,I1,2x,1PE16.8)') 'MSt', I,STMASS_H(I)
      enddo

      do I=1,2
      do J=1,2
         write(21,fmt='(A2,I1,I1,A1,2x,1PE16.8)')
...
* sBot      
      do  I=1,2
        write(21,fmt='(A3,I1,2x,1PE16.8)') 'MSb', I,SBMASS_H(I)
      enddo
...
* sTau
      write(21,fmt='(A4,2x,1PE16.8)') 'MSnl', SNU3MASS_H
      do  I=1,2
        write(21,fmt='(A3,I1,2x,1PE16.8)') 'MSl', I,STAUMASS_H(I)
      enddo
...
* Neutralino
      do  I=1,4
        write(21,fmt='(A3,I1,2x,1PE16.8)') 'MNE', I,MN_H(I)
      enddo
...
* Chargino 
      do  I=1,2
        write(21,fmt='(A2,I1,2x,1PE16.8)') 'MC', I,MC_H(I)
      enddo
