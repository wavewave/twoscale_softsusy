...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.44371817e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=7.12010231e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03946734e+01   # MW
        25     1.14138882e+02   # h0
        35     8.96362584e+02   # H0
        36     8.96177833e+02   # A0
        37     9.00002951e+02   # H+
   ...
   1000035     8.69334638e+02   # ~neutralino(4)
...
Block Vmix                  # chargino V mixing matrix 
  ...
  1  2    -3.78615293e-02   # V_{1,2}
  2  1     3.78615293e-02   # V_{2,1}
...
Block staumix               # stau mixing matrix
  1  1     5.86352867e-01   # F_{11}
  1  2     8.10055749e-01   # F_{12}
  2  1     8.10055749e-01   # F_{21}
  2  2    -5.86352867e-01   # F_{22}
...
Block msoft Q= 8.41433931e+02  # MSSM DRbar SUSY breaking parameters
    ...
    21     4.93764054e+04      # mH1^2(Q)
    22    -7.27136831e+05      # mH2^2(Q)
    ...
    43     9.07849792e+02      # mqL3(Q)
    44     1.05268653e+03      # muR(Q)
    45     1.05268039e+03      # mcR(Q)
    46     7.69257214e+02      # mtR(Q)
...
Block ae Q= 8.41433931e+02  
  1  1     4.90564486e+02      # Ae(Q)MSSM DRbar
