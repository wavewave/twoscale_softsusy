...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.84678087e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=8.70321059e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03950920e+01   # MW
        25     1.15553073e+02   # h0
        35     8.03087423e+02   # H0
        36     8.02826079e+02   # A0
        37     8.07093510e+02   # H+
   ...
   1000025    -6.90977510e+02   # ~neutralino(3)
   1000035     7.03992566e+02   # ~neutralino(4)
   1000037     7.04268731e+02   # ~chargino(2)
   ...
   1000006     8.88689224e+02   # ~t_1
   1000011     4.34554245e+02   # ~e_L
   1000012     4.27133857e+02   # ~nue_L
   1000013     4.34549963e+02   # ~mu_L
   1000014     4.27129520e+02   # ~numu_L
   1000015     3.01537734e+02   # ~stau_1
   1000016     4.25661998e+02   # ~nu_tau_L
   2000001     1.11633698e+03   # ~d_R
   2000002     1.12016843e+03   # ~u_R
   2000003     1.11633397e+03   # ~s_R
   2000004     1.12016534e+03   # ~c_R
   2000005     1.11207660e+03   # ~b_2
   2000006     1.10554971e+03   # ~t_2
   2000011     3.08209008e+02   # ~e_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.47844582e-02   # N_{1,2}
  1  3     7.63268338e-02   # N_{1,3}
  1  4    -3.21134475e-02   # N_{1,4}
  2  1     3.28926953e-02   # N_{2,1}
  2  2     9.73481144e-01   # N_{2,2}
  2  3    -1.87436954e-01   # N_{2,3}
  2  4     1.26964248e-01   # N_{2,4}
  3  1    -3.04501323e-02   # N_{3,1}
  3  2     4.42289546e-02   # N_{3,2}
  3  3     7.04034271e-01   # N_{3,3}
  3  4     7.08132992e-01   # N_{3,4}
  4  1    -7.11793461e-02   # N_{4,1}
  4  2     2.23963571e-01   # N_{4,2}
  4  3     6.80718259e-01   # N_{4,3}
  4  4    -6.93827408e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.63398275e-01   # U_{1,1}
  1  2    -2.68074175e-01   # U_{1,2}
  2  1     2.68074175e-01   # U_{2,1}
  2  2     9.63398275e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.83263989e-01   # V_{1,1}
  1  2    -1.82186521e-01   # V_{1,2}
  2  1     1.82186521e-01   # V_{2,1}
  2  2     9.83263989e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.97158313e-01   # F_{11}
  1  2     9.17750115e-01   # F_{12}
  2  1     9.17750115e-01   # F_{21}
  2  2    -3.97158313e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     9.82672501e-01   # F_{11}
  1  2     1.85350360e-01   # F_{12}
  2  1    -1.85350360e-01   # F_{21}
...
Block gauge Q= 9.61499553e+02  # SM gauge couplings
     1     3.62546416e-01   # g'(Q)MSSM DRbar
     2     6.42427804e-01   # g(Q)MSSM DRbar
     3     1.05598973e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.61499553e+02  
  3  3     8.58048312e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.61499553e+02  
  3  3     1.34717941e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.61499553e+02  
  3  3     1.00441673e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.61499553e+02 # Higgs mixing parameters
     1     6.85470013e+02    # mu(Q)MSSM DRbar
     2     9.66211839e+00    # tan beta(Q)MSSM DRbar
     3     2.43998344e+02    # higgs vev(Q)MSSM DRbar
     4     6.67569450e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.61499553e+02  # MSSM DRbar SUSY breaking parameters
     1     2.31222590e+02      # M_1(Q)
     2     4.28205323e+02      # M_2(Q)
     3     1.21637151e+03      # M_3(Q)
    21     1.62290542e+05      # mH1^2(Q)
    22    -4.53186365e+05      # mH2^2(Q)
