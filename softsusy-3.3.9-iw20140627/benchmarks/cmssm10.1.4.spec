...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.71847249e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.46898227e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03938777e+01   # MW
        25     1.16590648e+02   # h0
        35     9.13242847e+02   # H0
        36     9.13026404e+02   # A0
        37     9.16774508e+02   # H+
   1000021     1.46095547e+03   # ~g
   1000022     2.69508387e+02   # ~neutralino(1)
   1000023     5.09956384e+02   # ~neutralino(2)
   1000024     5.10035621e+02   # ~chargino(1)
   1000025    -8.00033179e+02   # ~neutralino(3)
   1000035     8.11933688e+02   # ~neutralino(4)
   1000037     8.12151784e+02   # ~chargino(2)
   1000001     1.34148428e+03   # ~d_L
   1000002     1.33928636e+03   # ~u_L
   1000003     1.34148104e+03   # ~s_L
   1000004     1.33928312e+03   # ~c_L
   1000005     1.22965201e+03   # ~b_1
   1000006     1.03422910e+03   # ~t_1
   1000011     4.66795082e+02   # ~e_L
   1000012     4.59872915e+02   # ~nue_L
   1000013     4.66790892e+02   # ~mu_L
   1000014     4.59868681e+02   # ~numu_L
   1000015     2.89085670e+02   # ~stau_1
   1000016     4.58388363e+02   # ~nu_tau_L
   2000001     1.28307315e+03   # ~d_R
   2000002     1.28804484e+03   # ~u_R
   2000003     1.28306977e+03   # ~s_R
   2000004     1.28804137e+03   # ~c_R
   2000005     1.27806334e+03   # ~b_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.10125147e-02   # N_{1,2}
  1  3     6.59568821e-02   # N_{1,3}
  1  4    -2.83149570e-02   # N_{1,4}
  2  1     2.53163322e-02   # N_{2,1}
  2  2     9.78266674e-01   # N_{2,2}
  2  3    -1.69169644e-01   # N_{2,3}
  2  4     1.17196540e-01   # N_{2,4}
  3  1    -2.60993970e-02   # N_{3,1}
  3  2     3.77605073e-02   # N_{3,2}
  3  3     7.04849143e-01   # N_{3,3}
  3  4     7.07870504e-01   # N_{3,4}
  4  1    -6.28587891e-02   # N_{4,1}
  4  2     2.03585811e-01   # N_{4,2}
  4  3     6.85725168e-01   # N_{4,3}
  4  4    -6.95975993e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.70471852e-01   # U_{1,1}
  1  2    -2.41214395e-01   # U_{1,2}
  2  1     2.41214395e-01   # U_{2,1}
  2  2     9.70471852e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.85868276e-01   # V_{1,1}
  1  2    -1.67522363e-01   # V_{1,2}
  2  1     1.67522363e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     1.81466180e-01   # F_{12}
  2  1    -1.81466180e-01   # F_{21}
...
Block au Q= 1.11123520e+03  
  ...
  2  2    -1.44271737e+03      # Ac(Q)MSSM DRbar
...
Block ae Q= 1.11123520e+03  
  1  1    -3.84551080e+02      # Ae(Q)MSSM DRbar
  2  2    -3.84544281e+02      # Amu(Q)MSSM DRbar
  3  3    -3.82487968e+02      # Atau(Q)MSSM DRbar
