...
# PDG code     mass             particle
        ...
        37     2.44656371e+02   # charged scalar
   1000021     1.25249571e+03   # ~g
   1000022     2.27135124e+02   # ~neutralino(1)
   1000023     4.28319255e+02   # ~neutralino(2)
   1000024     4.28364437e+02   # ~chargino(1)
   1000025    -6.97935457e+02   # ~neutralino(3)
   1000035     7.10632422e+02   # ~neutralino(4)
   1000037     7.10917474e+02   # ~chargino(2)
   1000011     2.51771131e+02   # charged scalar
   1000013     2.51793397e+02   # charged scalar
   1000015     3.95689623e+02   # charged scalar
   2000011     3.95725824e+02   # charged scalar
   2000013     3.95729370e+02   # charged scalar
   2000015     7.85515240e+02   # charged scalar
   1000012     3.87569153e+02   # CP even neutral scalar
   1000014     3.87572783e+02   # CP even neutral scalar
   1000016     7.81158397e+02   # CP even neutral scalar
   1000017     3.87569153e+02   # CP odd neutral scalar
   1000018     3.87572783e+02   # CP odd neutral scalar
   1000019     7.81158397e+02   # CP odd neutral scalar
   1000001     1.05575317e+03   # ~d_1
   1000003     1.09482128e+03   # ~d_2
   1000005     1.10302438e+03   # ~d_3
   2000001     1.10302813e+03   # ~d_4
   2000003     1.15179298e+03   # ~d_5
   2000005     1.15181361e+03   # ~d_6
   1000002     8.84190967e+02   # ~u_1
   1000004     1.08710553e+03   # ~u_2
   1000006     1.10687835e+03   # ~u_3
   2000002     1.10688394e+03   # ~u_4
   2000004     1.14921847e+03   # ~u_5
   2000006     1.14922287e+03   # ~u_6
...
Block RVUMIX  # lepton-chargino mixing matrix U
  ...
  4 4    9.64732234e-01   # U_{44}
  4 5   -2.63233200e-01   # U_{45}
  5 1    0.00000000e+00   # U_{51}
  5 2    0.00000000e+00   # U_{52}
  5 3    0.00000000e+00   # U_{53}
  5 4    2.63233200e-01   # U_{54}
  5 5    9.64732234e-01   # U_{55}
Block RVVMIX  # lepton-chargino mixing matrix V
  ...
  4 5   -1.73961830e-01   # V_{45}
  5 1    0.00000000e+00   # V_{51}
  5 2    0.00000000e+00   # V_{52}
  5 3    0.00000000e+00   # V_{53}
  5 4    1.73961830e-01   # V_{54}
  5 5    9.84752396e-01   # V_{55}
Block gauge Q= 9.55780049e+02  # SM gauge couplings
     1     3.62891621e-01   # g'(Q)MSSM DRbar
     2     6.41875133e-01   # g(Q)MSSM DRbar
     3     1.05977261e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.55780049e+02   # diagonal Up Yukawa matrix
  1  1     7.31062073e-06    # YU_{11}(Q)MSSM DRbar
  2  2     3.34879838e-03    # YU_{22}(Q)MSSM DRbar
  3  3     8.54640020e-01    # YU_{33}(Q)MSSM DRbar
Block yd Q= 9.55780049e+02   # diagonal down Yukawa matrix
  1  1     1.40687409e-04    # YD_{11}(Q)MSSM DRbar
  2  2     3.08037441e-03    # YD_{22}(Q)MSSM DRbar
  3  3     1.34276862e-01    # YD_{33}(Q)MSSM DRbar
Block ye Q= 9.55780049e+02   # diagonal lepton Yukawa matrix
  1  1     2.78733251e-05    # YE_{11}(Q)MSSM DRbar
  2  2     5.76332788e-03    # YE_{22}(Q)MSSM DRbar
  3  3     1.00247608e-01    # YE_{33}(Q)MSSM DRbar
Block hmix Q= 9.55780049e+02 # Higgs mixing parameters
     1     6.92550340e+02    # mu(Q)MSSM DRbar
     2     9.66513558e+00    # tan beta(Q)MSSM DRbar
     3     2.44434433e+02    # higgs vev(Q)MSSM DRbar
     4     6.32788284e+05    # mA^2(Q)MSSM DRbar
Block RVLAMLLE Q= 9.55780049e+02 # non-zero R-Parity violating LLE couplings 
Block RVLAMLQD Q= 9.55780049e+02 # non-zero R-Parity violating LQD couplings 
Block RVLAMUDD Q= 9.55780049e+02 # non-zero R-Parity violating UDD couplings 
  1 1 2   -6.04098402e-21   # lambda''_{112}
  1 1 3   -5.97829911e-24   # lambda''_{113}
  1 2 1    6.04098402e-21   # lambda''_{121}
  1 2 3    9.99999857e-05   # lambda''_{123}
  1 3 1    5.97829911e-24   # lambda''_{131}
  1 3 2   -9.99999857e-05   # lambda''_{132}
  2 1 2   -9.92697155e-27   # lambda''_{212}
  2 1 3   -9.66907319e-30   # lambda''_{213}
  2 2 1    9.92697155e-27   # lambda''_{221}
  2 2 3   -5.51397377e-16   # lambda''_{223}
  2 3 1    9.66907319e-30   # lambda''_{231}
  2 3 2    5.51397377e-16   # lambda''_{232}
  3 1 2    2.30361726e-25   # lambda''_{312}
  3 1 3    2.24367686e-28   # lambda''_{313}
  3 2 1   -2.30361726e-25   # lambda''_{321}
  3 2 3    1.29243679e-14   # lambda''_{323}
  3 3 1   -2.24367686e-28   # lambda''_{331}
  3 3 2   -1.29243679e-14   # lambda''_{332}
Block RVTLLE Q= 9.55780049e+02 # non-zero R-Parity violating LLE soft terms 
Block RVTLQD Q= 9.55780049e+02 # non-zero R-Parity violating LQD soft terms 
Block RVTUDD Q= 9.55780049e+02 # non-zero R-Parity violating UDD soft terms 
  1 1 2   -4.08181643e-17   # T''_{112}
  1 1 3   -4.01074540e-20   # T''_{113}
  1 2 1    4.08181643e-17   # T''_{121}
  1 2 3    3.42483705e-08   # T''_{123}
  1 3 1    4.01074540e-20   # T''_{131}
  1 3 2   -3.42483705e-08   # T''_{132}
  2 1 2    1.33212012e-22   # T''_{212}
  2 1 3    1.29655502e-25   # T''_{213}
  2 2 1   -1.33212012e-22   # T''_{221}
  2 2 3    1.07818870e-12   # T''_{223}
  2 3 1   -1.29655502e-25   # T''_{231}
  2 3 2   -1.07818870e-12   # T''_{232}
  3 1 2   -3.08270771e-21   # T''_{312}
  3 1 3   -3.00015923e-24   # T''_{313}
  3 2 1    3.08270771e-21   # T''_{321}
  3 2 3   -2.51735545e-11   # T''_{323}
  3 3 1    3.00015923e-24   # T''_{331}
  3 3 2    2.51735545e-11   # T''_{332}
Block RVKAPPA Q= 9.55780049e+02 # R-Parity violating kappa 
     1    0.00000000e+00   # kappa_{1}
     2    0.00000000e+00   # kappa_{2}
     3    0.00000000e+00   # kappa_{3}
Block RVD Q= 9.55780049e+02 # R-Parity violating D 
     1    0.00000000e+00   # D_{1}
     2    0.00000000e+00   # D_{2}
     3    0.00000000e+00   # D_{3}
Block RVSNVEV Q= 9.55780049e+02 # sneutrino VEVs D 
     1    0.00000000e+00   # SneutrinoVev_{1}
     2    0.00000000e+00   # SneutrinoVev_{2}
     3    0.00000000e+00   # SneutrinoVev_{3}
Block RVM2LH1 Q= 9.55780049e+02 # M2LH1 
...
Block msq2 Q= 9.55780049e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     1.23574819e+06    # (m^_Q^2)_{11}
  1  2     4.23671375e+01    # (m^_Q^2)_{12}
  1  3    -1.00189543e+03    # (m^_Q^2)_{13}
  2  1     4.23671375e+01    # (m^_Q^2)_{21}
  2  2     1.23544117e+06    # (m^_Q^2)_{22}
  2  3     7.37615207e+03    # (m^_Q^2)_{23}
  3  1    -1.00189543e+03    # (m^_Q^2)_{31}
  3  2     7.37615207e+03    # (m^_Q^2)_{32}
  3  3     1.05248695e+06    # (m^_Q^2)_{33}
Block msl2 Q= 9.55780049e+02 # super MNS slepton mass^2 matrix - DRbar
...
Block msd2 Q= 9.55780049e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     1.13396924e+06    # (m^_d^2)_{11}
  1  2    -3.00150638e-06    # (m^_d^2)_{12}
  1  3     3.10663134e-03    # (m^_d^2)_{13}
  2  1    -3.00150638e-06    # (m^_d^2)_{21}
  2  2     1.13396296e+06    # (m^_d^2)_{22}
  2  3    -5.00778857e-01    # (m^_d^2)_{23}
  3  1     3.10663134e-03    # (m^_d^2)_{31}
  3  2    -5.00778857e-01    # (m^_d^2)_{32}
  3  3     1.12258142e+06    # (m^_d^2)_{33}
Block msu2 Q= 9.55780049e+02 # super CKM squark mass^2 matrix - DRbar
  1  1     1.14483492e+06    # (m^_u^2)_{11}
  1  2     1.55827744e-03    # (m^_u^2)_{12}
  1  3    -5.27720121e-05    # (m^_u^2)_{13}
  2  1     1.55827744e-03    # (m^_u^2)_{21}
  2  2     1.14482848e+06    # (m^_u^2)_{22}
  2  3    -6.63798798e-02    # (m^_u^2)_{23}
  3  1    -5.27720121e-05    # (m^_u^2)_{31}
  3  2    -6.63798798e-02    # (m^_u^2)_{32}
  3  3     7.80568352e+05    # (m^_u^2)_{33}
Block mse2 Q= 9.55780049e+02 # super MNS slepton mass^2 matrix - DRbar
  1  1     5.94825290e+04    # (m^_e^2)_{11}
...
Block tu Q= 9.55780049e+02   # super CKM trilinear matrix - DRbar
  1  1    -9.10504594e-03    # (T^_u)_{11}
  1  2    -1.77708673e-08    # (T^_u)_{12}
  1  3    -9.65860683e-08    # (T^_u)_{13}
  2  1    -8.87982752e-06    # (T^_u)_{21}
  2  2    -4.17081098e+00    # (T^_u)_{22}
  2  3    -4.19327253e-04    # (T^_u)_{23}
  3  1    -1.18996000e-02    # (T^_u)_{31}
  3  2    -1.26297991e-01    # (T^_u)_{32}
  3  3    -8.26465665e+02    # (T^_u)_{33}
Block td Q= 9.55780049e+02   # super CKM trilinear matrix - DRbar
  1  1    -2.13478039e-01    # (T^_d)_{11}
  1  2    -3.13923258e-06    # (T^_d)_{12}
  1  3     7.46299544e-05    # (T^_d)_{13}
  2  1    -6.87337688e-05    # (T^_d)_{21}
  2  2    -4.67365070e+00    # (T^_d)_{22}
  2  3    -1.20300675e-02    # (T^_d)_{23}
  3  1     7.10930977e-02    # (T^_d)_{31}
  3  2    -5.23402348e-01    # (T^_d)_{32}
  3  3    -1.90646256e+02    # (T^_d)_{33}
Block te Q= 9.55780049e+02   # super CKM trilinear matrix - DRbar
  1  1    -9.07898535e-03    # (T^_e)_{11}
  1  2     0.00000000e+00    # (T^_e)_{12}
  1  3     0.00000000e+00    # (T^_e)_{13}
  2  1     0.00000000e+00    # (T^_e)_{21}
  2  2    -1.87721548e+00    # (T^_e)_{22}
  2  3     0.00000000e+00    # (T^_e)_{23}
  3  1     0.00000000e+00    # (T^_e)_{31}
  3  2     0.00000000e+00    # (T^_e)_{32}
  3  3    -3.24769982e+01    # (T^_e)_{33}
Block VCKM Q= 9.55780049e+02 # DRbar CKM mixing matrix
...
Block msoft Q= 9.55780049e+02 # MSSM DRbar SUSY breaking parameters
     1     2.32441171e+02     # M_1(Q)
     2     4.28956968e+02     # M_2(Q)
     3     1.21682755e+03     # M_3(Q)
    21     1.31346851e+05     # mH1^2(Q)
    22    -4.48802143e+05     # mH2^2(Q)
Block USQMIX  # super CKM squark mass^2 matrix
  1  1     2.10610576e-05   # (USQMIX)_{11}
  1  2     2.23014703e-04   # (USQMIX)_{12}
  1  3     4.08097279e-01   # (USQMIX)_{13}
  1  4     2.02569871e-10   # (USQMIX)_{14}
  ...
  2  4     5.44892002e-09   # (USQMIX)_{24}
  2  5     2.80307444e-05   # (USQMIX)_{25}
  2  6    -4.08097112e-01   # (USQMIX)_{26}
  3  1     1.42329223e-07   # (USQMIX)_{31}
  3  2     7.93868397e-03   # (USQMIX)_{32}
  3  3    -3.78040112e-05   # (USQMIX)_{33}
  3  4    -1.26050949e-04   # (USQMIX)_{34}
  3  5     9.99968479e-01   # (USQMIX)_{35}
  3  6     1.43195254e-05   # (USQMIX)_{36}
  4  1     1.73305878e-05   # (USQMIX)_{41}
  4  2     1.00112143e-06   # (USQMIX)_{42}
  4  3    -1.22932241e-08   # (USQMIX)_{43}
  4  4     9.99999992e-01   # (USQMIX)_{44}
  4  5     1.26046971e-04   # (USQMIX)_{45}
  4  6     4.54831233e-09   # (USQMIX)_{46}
  5  1     1.62526441e-01   # (USQMIX)_{51}
  5  2     9.86671844e-01   # (USQMIX)_{52}
  5  3    -1.51140877e-03   # (USQMIX)_{53}
  5  4    -2.81712530e-06   # (USQMIX)_{54}
  5  5    -7.83320965e-03   # (USQMIX)_{55}
  5  6     4.30851707e-04   # (USQMIX)_{56}
  6  1     9.86704177e-01   # (USQMIX)_{61}
  6  2    -1.62521352e-01   # (USQMIX)_{62}
  6  3     1.04503958e-04   # (USQMIX)_{63}
  6  4    -1.71000727e-05   # (USQMIX)_{64}
  6  5     1.29010810e-03   # (USQMIX)_{65}
  6  6    -2.97773834e-05   # (USQMIX)_{66}
Block DSQMIX  # super CKM squark mass^2 matrix
  ...
  1  4     9.11630737e-07   # (DSQMIX)_{14}
  1  5    -1.46963112e-04   # (DSQMIX)_{15}
  1  6     2.09445273e-01   # (DSQMIX)_{16}
  2  1    -1.65024033e-03   # (DSQMIX)_{21}
  2  2     1.21506386e-02   # (DSQMIX)_{22}
  2  3    -2.09141041e-01   # (DSQMIX)_{23}
  2  4    -2.03294831e-06   # (DSQMIX)_{24}
  2  5     3.27852199e-04   # (DSQMIX)_{25}
  2  6     9.77808548e-01   # (DSQMIX)_{26}
  3  1     1.71177807e-06   # (DSQMIX)_{31}
  3  2     4.07706622e-03   # (DSQMIX)_{32}
  3  3     3.58649266e-04   # (DSQMIX)_{33}
  3  4     4.70892348e-06   # (DSQMIX)_{34}
  3  5     9.99991577e-01   # (DSQMIX)_{35}
  3  6    -3.09239760e-04   # (DSQMIX)_{36}
  4  1     1.86787003e-04   # (DSQMIX)_{41}
  4  2     5.89311646e-08   # (DSQMIX)_{42}
  4  3    -2.22640691e-06   # (DSQMIX)_{43}
  4  4     9.99999983e-01   # (DSQMIX)_{44}
  4  5    -4.70813114e-06   # (DSQMIX)_{45}
  4  6     1.91897093e-06   # (DSQMIX)_{46}
  5  1    -1.36865247e-01   # (DSQMIX)_{51}
  5  2     9.89909904e-01   # (DSQMIX)_{52}
  5  3     3.61504716e-02   # (DSQMIX)_{53}
  5  4     2.55769382e-05   # (DSQMIX)_{54}
  5  5    -4.05017742e-03   # (DSQMIX)_{55}
  5  6    -4.79850878e-03   # (DSQMIX)_{56}
  6  1     9.90577497e-01   # (DSQMIX)_{61}
  6  2     1.36952061e-01   # (DSQMIX)_{62}
  6  3     8.61140124e-05   # (DSQMIX)_{63}
  6  4    -1.85037500e-04   # (DSQMIX)_{64}
  6  5    -5.60096536e-04   # (DSQMIX)_{65}
  6  6    -1.14243679e-05   # (DSQMIX)_{66}
