...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.71624633e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.24506936e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03886878e+01   # MW
        25     1.18308920e+02   # h0
        35     7.58115281e+02   # H0
        36     7.58120255e+02   # A0
        37     7.62665374e+02   # H+
   1000021     1.46727874e+03   # ~g
   1000022     2.72324154e+02   # ~neutralino(1)
   1000023     5.18124551e+02   # ~neutralino(2)
   1000024     5.18265832e+02   # ~chargino(1)
   1000025    -8.60813204e+02   # ~neutralino(3)
   1000035     8.68429006e+02   # ~neutralino(4)
   1000037     8.69329145e+02   # ~chargino(2)
   1000001     1.38375686e+03   # ~d_L
   ...
   1000011     5.75708850e+02   # ~e_L
   1000012     5.69951126e+02   # ~nue_L
   1000013     5.75566979e+02   # ~mu_L
   1000014     5.69808679e+02   # ~numu_L
   1000015     2.72394831e+02   # ~stau_1
   1000016     5.20575764e+02   # ~nu_tau_L
   2000001     1.32750302e+03   # ~d_R
   2000002     1.33228502e+03   # ~u_R
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -6.88787531e-03   # N_{1,2}
  1  3     5.88867067e-02   # N_{1,3}
  1  4    -2.03208090e-02   # N_{1,4}
  2  1     1.69719395e-02   # N_{2,1}
  2  2     9.85824318e-01   # N_{2,2}
  2  3    -1.42133819e-01   # N_{2,3}
  2  4     8.75233908e-02   # N_{2,4}
  3  1    -2.69124839e-02   # N_{3,1}
  3  2     3.92683843e-02   # N_{3,2}
  3  3     7.04925247e-01   # N_{3,3}
  3  4     7.07682209e-01   # N_{3,4}
  4  1    -5.39971648e-02   # N_{4,1}
  4  2     1.62975349e-01   # N_{4,2}
  4  3     6.92394923e-01   # N_{4,3}
  4  4    -7.00794272e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.79328146e-01   # U_{1,1}
  1  2    -2.02277985e-01   # U_{1,2}
  2  1     2.02277985e-01   # U_{2,1}
  2  2     9.79328146e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.92158877e-01   # V_{1,1}
  1  2    -1.24983052e-01   # V_{1,2}
  2  1     1.24983052e-01   # V_{2,1}
...
Block gauge Q= 1.08706486e+03  # SM gauge couplings
     1     3.62685065e-01   # g'(Q)MSSM DRbar
     2     6.41137384e-01   # g(Q)MSSM DRbar
     3     1.04857635e+00   # g3(Q)MSSM DRbar
Block yu Q= 1.08706486e+03  
  3  3     8.48084657e-01   # Yt(Q)MSSM DRbar
Block yd Q= 1.08706486e+03  
  3  3     4.89904405e-01   # Yb(Q)MSSM DRbar
Block ye Q= 1.08706486e+03  
  3  3     4.27865073e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 1.08706486e+03 # Higgs mixing parameters
     1     8.57816333e+02    # mu(Q)MSSM DRbar
     2     3.91757375e+01    # tan beta(Q)MSSM DRbar
     3     2.43738697e+02    # higgs vev(Q)MSSM DRbar
     4     7.28517224e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 1.08706486e+03  # MSSM DRbar SUSY breaking parameters
     1     2.76577979e+02      # M_1(Q)
     2     5.10367909e+02      # M_2(Q)
     3     1.42573128e+03      # M_3(Q)
    21    -1.63092367e+05      # mH1^2(Q)
    22    -7.21531133e+05      # mH2^2(Q)
    31     5.68931038e+02      # meL(Q)
    32     5.68787833e+02      # mmuL(Q)
...
Block au Q= 1.08706486e+03  
  1  1    -1.78771101e+03      # Au(Q)MSSM DRbar
  2  2    -1.78766909e+03      # Ac(Q)MSSM DRbar
  3  3    -1.25732016e+03      # At(Q)MSSM DRbar
Block ad Q= 1.08706486e+03  
  1  1    -2.06510900e+03      # Ad(Q)MSSM DRbar
  2  2    -2.06500226e+03      # As(Q)MSSM DRbar
  3  3    -1.74605086e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.08706486e+03  
  1  1    -6.86158558e+02      # Ae(Q)MSSM DRbar
  2  2    -6.85825525e+02      # Amu(Q)MSSM DRbar
  3  3    -5.74035181e+02      # Atau(Q)MSSM DRbar
