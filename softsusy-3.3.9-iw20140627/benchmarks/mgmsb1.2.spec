...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.96002636e-04
...
# PDG code     mass             particle
   ...
   1000037     3.86225459e+02   # ~chargino(2)
   ...
   1000011     2.62668613e+02   # ~e_L
   1000012     2.50063270e+02   # ~nue_L
   1000013     2.62667568e+02   # ~mu_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -6.51724513e-02   # N_{1,2}
  1  3     2.20681195e-01   # N_{1,3}
  1  4    -1.26956939e-01   # N_{1,4}
  2  1    -2.33239486e-01   # N_{2,1}
  2  2    -6.35464559e-01   # N_{2,2}
  2  3     5.51918227e-01   # N_{2,3}
  2  4    -4.87001445e-01   # N_{2,4}
  3  1    -6.00530809e-02   # N_{3,1}
  3  2     8.12363287e-02   # N_{3,2}
  3  3     6.95698709e-01   # N_{3,3}
  3  4     7.11194483e-01   # N_{3,4}
  4  1    -1.05160222e-01   # N_{4,1}
  4  2     7.65073856e-01   # N_{4,2}
  4  3     4.03347724e-01   # N_{4,3}
  4  4    -4.90829845e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -5.68948507e-01   # U_{1,1}
  1  2     8.22373149e-01   # U_{1,2}
  2  1    -8.22373149e-01   # U_{2,1}
  2  2    -5.68948507e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -6.93736220e-01   # V_{1,1}
  1  2     7.20229170e-01   # V_{1,2}
  2  1    -7.20229170e-01   # V_{2,1}
  2  2    -6.93736220e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     5.69613492e-01   # F_{11}
  1  2     8.21912690e-01   # F_{12}
  2  1     8.21912690e-01   # F_{21}
  2  2    -5.69613492e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.52525654e-01   # F_{11}
  1  2     9.88299512e-01   # F_{12}
  2  1     9.88299512e-01   # F_{21}
  2  2    -1.52525654e-01   # F_{22}
