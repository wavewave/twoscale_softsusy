...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.23178534e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.04070220e+01   # MW
   ...
   1000037     2.56149716e+03   # ~chargino(2)
   ...
   1000011     2.49220029e+02   # ~e_L
   1000012     2.36602395e+02   # ~nue_L
   1000013     2.49220029e+02   # ~mu_L
   1000014     2.36602395e+02   # ~numu_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -3.68550858e-04   # N_{1,2}
  1  3     1.77192112e-02   # N_{1,3}
  1  4    -2.47475135e-03   # N_{1,4}
  2  1     9.01612887e-03   # N_{2,1}
  2  2     7.96260872e-01   # N_{2,2}
  2  3    -4.33233039e-01   # N_{2,3}
  2  4     4.22133234e-01   # N_{2,4}
  3  1    -1.07736838e-02   # N_{3,1}
  3  2     9.83264248e-03   # N_{3,2}
  3  3     7.06896281e-01   # N_{3,3}
  3  4     7.07166809e-01   # N_{3,4}
  4  1    -1.10845761e-02   # N_{4,1}
  4  2     6.04873381e-01   # N_{4,2}
  4  3     5.58831649e-01   # N_{4,3}
  4  4    -5.67197067e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -6.86614851e-01   # U_{1,1}
  1  2     7.27021352e-01   # U_{1,2}
  2  1    -7.27021352e-01   # U_{2,1}
  2  2    -6.86614851e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -7.00859671e-01   # V_{1,1}
  1  2     7.13299181e-01   # V_{1,2}
  2  1    -7.13299181e-01   # V_{2,1}
  2  2    -7.00859671e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.20705278e-01   # F_{11}
  1  2     9.07197371e-01   # F_{12}
  2  1     9.07197371e-01   # F_{21}
  2  2    -4.20705278e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     3.95734116e-01   # F_{11}
  1  2     9.18365129e-01   # F_{12}
  2  1     9.18365129e-01   # F_{21}
  2  2    -3.95734116e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     4.02904899e-01   # F_{11}
  1  2     9.15241849e-01   # F_{12}
  2  1     9.15241849e-01   # F_{21}
  2  2    -4.02904899e-01   # F_{22}
Block gauge Q= 2.50366832e+03  # SM gauge couplings
     1     3.64752474e-01   # g'(Q)MSSM DRbar
     2     6.36107772e-01   # g(Q)MSSM DRbar
     3     1.01384480e+00   # g3(Q)MSSM DRbar
Block yu Q= 2.50366832e+03  
  3  3     8.33727950e-01   # Yt(Q)MSSM DRbar
Block yd Q= 2.50366832e+03  
  3  3     1.25706199e-01   # Yb(Q)MSSM DRbar
Block ye Q= 2.50366832e+03  
  3  3     9.97636467e-02   # Ytau(Q)MSSM DRbar
...
Block au Q= 2.50366832e+03  
  1  1     6.10913288e-06      # Au(Q)MSSM DRbar
  2  2     6.10920536e-06      # Ac(Q)MSSM DRbar
  3  3     1.02291183e-05      # At(Q)MSSM DRbar
Block ad Q= 2.50366832e+03  
  1  1     2.09531540e-06      # Ad(Q)MSSM DRbar
  2  2     2.09539018e-06      # As(Q)MSSM DRbar
  3  3     3.43596492e-06      # Ab(Q)MSSM DRbar
Block ae Q= 2.50366832e+03  
  1  1     0.00000000e+00      # Ae(Q)MSSM DRbar
  2  2     1.21813501e-07      # Amu(Q)MSSM DRbar
  3  3     1.22120273e-07      # Atau(Q)MSSM DRbar
