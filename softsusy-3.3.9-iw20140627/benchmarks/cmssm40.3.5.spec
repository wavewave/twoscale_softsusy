...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.08986766e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.61914941e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03908418e+01   # MW
        25     1.16886826e+02   # h0
        35     9.42583355e+02   # H0
        36     9.42686467e+02   # A0
        37     9.46261957e+02   # H+
   1000021     1.10074818e+03   # ~g
   1000022     1.88514969e+02   # ~neutralino(1)
   1000023     3.60117299e+02   # ~neutralino(2)
   1000024     3.60224624e+02   # ~chargino(1)
   1000025    -6.19932737e+02   # ~neutralino(3)
   1000035     6.30468389e+02   # ~neutralino(4)
   1000037     6.31566368e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.28130148e-02   # N_{1,2}
  1  3     8.20672311e-02   # N_{1,3}
  1  4    -2.72476781e-02   # N_{1,4}
  2  1     3.11359339e-02   # N_{2,1}
  2  2     9.75151544e-01   # N_{2,2}
  2  3    -1.88406140e-01   # N_{2,3}
  2  4     1.12308267e-01   # N_{2,4}
  3  1    -3.78244787e-02   # N_{3,1}
  3  2     5.54584956e-02   # N_{3,2}
  3  3     7.02897009e-01   # N_{3,3}
  3  4     7.08116840e-01   # N_{3,4}
  4  1    -7.23982194e-02   # N_{4,1}
  4  2     2.14101959e-01   # N_{4,2}
  4  3     6.80958069e-01   # N_{4,3}
  4  4    -6.96573728e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.63198429e-01   # U_{1,1}
  1  2    -2.68791343e-01   # U_{1,2}
  2  1     2.68791343e-01   # U_{2,1}
  2  2     9.63198429e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.86987592e-01   # V_{1,1}
  1  2    -1.60796434e-01   # V_{1,2}
  2  1     1.60796434e-01   # V_{2,1}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     1.76691805e-01   # F_{12}
  2  1    -1.76691805e-01   # F_{21}
...
Block ae Q= 1.06740664e+03  
  1  1    -5.92607870e+02      # Ae(Q)MSSM DRbar
  2  2    -5.92303273e+02      # Amu(Q)MSSM DRbar
  3  3    -4.97393922e+02      # Atau(Q)MSSM DRbar
