...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.66937866e-05
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03989120e+01   # MW
        25     1.14113382e+02   # h0
        35     5.59347724e+02   # H0
        36     5.59107959e+02   # A0
        37     5.65052721e+02   # H+
   1000021     1.39075818e+03   # ~g
   1000022     2.55824314e+02   # ~neutralino(1)
   1000023     4.07201645e+02   # ~neutralino(2)
   1000024     4.04084978e+02   # ~chargino(1)
   1000025    -4.37205734e+02   # ~neutralino(3)
   1000035     5.44211976e+02   # ~neutralino(4)
   ...
   2000015     3.89420802e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -7.38342864e-02       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.78797163e-01   # N_{1,1}
  1  2    -3.68082983e-02   # N_{1,2}
  1  3     1.70079784e-01   # N_{1,3}
  1  4    -1.08046886e-01   # N_{1,4}
  2  1    -1.90871483e-01   # N_{2,1}
  2  2    -4.82727631e-01   # N_{2,2}
  2  3     6.20686142e-01   # N_{2,3}
  2  4    -5.87614521e-01   # N_{2,4}
  3  1    -4.15520226e-02   # N_{3,1}
  3  2     5.52875294e-02   # N_{3,2}
  3  3     7.01620371e-01   # N_{3,3}
  3  4     7.09186558e-01   # N_{3,4}
  4  1    -6.16248282e-02   # N_{4,1}
  4  2     8.73248231e-01   # N_{4,2}
  4  3     3.05860157e-01   # N_{4,3}
  4  4    -3.74285281e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1    -4.29953129e-01   # U_{1,1}
  1  2     9.02851209e-01   # U_{1,2}
  2  1    -9.02851209e-01   # U_{2,1}
  2  2    -4.29953129e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1    -5.26618171e-01   # V_{1,1}
  1  2     8.50101936e-01   # V_{1,2}
  2  1    -8.50101936e-01   # V_{2,1}
  2  2    -5.26618171e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.15414449e-01   # F_{11}
  1  2     9.09632253e-01   # F_{12}
  2  1     9.09632253e-01   # F_{21}
  2  2    -4.15414449e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     9.82184943e-02   # F_{11}
  1  2     9.95164874e-01   # F_{12}
  2  1     9.95164874e-01   # F_{21}
  2  2    -9.82184943e-02   # F_{22}
...
Block msoft Q= 1.18797354e+03  # MSSM DRbar SUSY breaking parameters
     ...
     2     4.99442106e+02      # M_2(Q)
     3     1.33309541e+03      # M_3(Q)
    21     1.25658112e+05      # mH1^2(Q)
    22    -1.57186980e+05      # mH2^2(Q)
...
Block ad Q= 1.18797354e+03  
  ...
  3  3    -3.99995762e+02      # Ab(Q)MSSM DRbar
Block ae Q= 1.18797354e+03  
  1  1    -4.02928015e+01      # Ae(Q)MSSM DRbar
  2  2    -4.02925188e+01      # Amu(Q)MSSM DRbar
  3  3    -4.02054034e+01      # Atau(Q)MSSM DRbar
