...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.84442791e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=9.30306547e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03892151e+01   # MW
        25     1.18044336e+02   # h0
        35     8.07413864e+02   # H0
        36     8.07405579e+02   # A0
        37     8.11722814e+02   # H+
   1000021     1.38443720e+03   # ~g
   1000022     2.51958970e+02   # ~neutralino(1)
   1000023     4.79886527e+02   # ~neutralino(2)
   1000024     4.80022396e+02   # ~chargino(1)
   1000025    -8.00378630e+02   # ~neutralino(3)
   1000035     8.08687281e+02   # ~neutralino(4)
   1000037     8.09619123e+02   # ~chargino(2)
   1000001     1.41605873e+03   # ~d_L
   1000002     1.41397732e+03   # ~u_L
   1000003     1.41601733e+03   # ~s_L
   1000004     1.41393585e+03   # ~c_L
   1000005     1.17796190e+03   # ~b_1
   1000006     1.00406387e+03   # ~t_1
   1000011     8.05718036e+02   # ~e_L
   1000012     8.01474039e+02   # ~nue_L
   1000013     8.05519669e+02   # ~mu_L
   1000014     8.01276197e+02   # ~numu_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -7.90296461e-03   # N_{1,2}
  1  3     6.33754023e-02   # N_{1,3}
  1  4    -2.17269183e-02   # N_{1,4}
  2  1     1.94559191e-02   # N_{2,1}
  2  2     9.83846377e-01   # N_{2,2}
  2  3    -1.51734187e-01   # N_{2,3}
  2  4     9.29758582e-02   # N_{2,4}
  3  1    -2.90076552e-02   # N_{3,1}
  3  2     4.23546953e-02   # N_{3,2}
  3  3     7.04589626e-01   # N_{3,3}
  3  4     7.07755674e-01   # N_{3,4}
  4  1    -5.77146480e-02   # N_{4,1}
  4  2     1.73752495e-01   # N_{4,2}
  4  3     6.90299756e-01   # N_{4,3}
  4  4    -6.99975240e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.76349973e-01   # U_{1,1}
  1  2    -2.16196047e-01   # U_{1,2}
  2  1     2.16196047e-01   # U_{2,1}
  2  2     9.76349973e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.91117433e-01   # V_{1,1}
  1  2    -1.32989604e-01   # V_{1,2}
  2  1     1.32989604e-01   # V_{2,1}
  2  2     9.91117433e-01   # V_{2,2}
...
Block msoft Q= 1.07990047e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21     3.00560905e+04      # mH1^2(Q)
    22    -6.19235179e+05      # mH2^2(Q)
    ...
    46     9.99597966e+02      # mtR(Q)
    47     1.33211499e+03      # mdR(Q)
    48     1.33203103e+03      # msR(Q)
    49     1.20515186e+03      # mbR(Q)
...
Block ae Q= 1.07990047e+03  
  1  1    -6.62570196e+02      # Ae(Q)MSSM DRbar
