...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.58516420e-04
...
# PDG code     mass             particle
   ...
   1000023     2.65580927e+02   # ~neutralino(2)
   ...
   1000014     3.07428162e+02   # ~numu_L
   1000015     1.52910784e+02   # ~stau_1
   1000016     3.06808059e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -4.32827634e-02   # N_{1,2}
  1  3     1.57617675e-01   # N_{1,3}
  1  4    -7.20496632e-02   # N_{1,4}
  2  1     1.21894012e-01   # N_{2,1}
  2  2     8.64319900e-01   # N_{2,2}
  2  3    -3.88782564e-01   # N_{2,3}
  2  4     2.94857724e-01   # N_{2,4}
  3  1    -5.62221676e-02   # N_{3,1}
  3  2     7.93621045e-02   # N_{3,2}
  3  3     6.97353540e-01   # N_{3,3}
  3  4     7.10097715e-01   # N_{3,4}
  4  1    -1.17850755e-01   # N_{4,1}
  4  2     4.94751825e-01   # N_{4,2}
  4  3     5.81122042e-01   # N_{4,3}
  4  4    -6.35318033e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.23293322e-01   # U_{1,1}
  1  2    -5.67616161e-01   # U_{1,2}
  2  1     5.67616161e-01   # U_{2,1}
  2  2     8.23293322e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02286553e-01   # V_{1,1}
  1  2    -4.31136841e-01   # V_{1,2}
  2  1     4.31136841e-01   # V_{2,1}
  2  2     9.02286553e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.77262008e-01   # F_{11}
  1  2     9.60794348e-01   # F_{12}
  2  1     9.60794348e-01   # F_{21}
  2  2    -2.77262008e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     4.75885294e-01   # F_{11}
  1  2     8.79507355e-01   # F_{12}
  2  1     8.79507355e-01   # F_{21}
  2  2    -4.75885294e-01   # F_{22}
...
Block msoft Q= 9.37893983e+02  # MSSM DRbar SUSY breaking parameters
    ...
    21     8.47389574e+04      # mH1^2(Q)
    22    -1.13696801e+05      # mH2^2(Q)
    31     3.11339119e+02      # meL(Q)
    32     3.11337730e+02      # mmuL(Q)
    33     3.10913692e+02      # mtauL(Q)
...
Block au Q= 9.37893983e+02  
  1  1    -2.41594330e+02      # Au(Q)MSSM DRbar
...
Block ae Q= 9.37893983e+02  
  1  1    -2.43961764e+01      # Ae(Q)MSSM DRbar
  2  2    -2.43959959e+01      # Amu(Q)MSSM DRbar
