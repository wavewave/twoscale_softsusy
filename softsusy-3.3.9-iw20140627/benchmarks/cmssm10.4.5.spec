...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.99386285e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=4.27645805e-04
...
# PDG code     mass             particle
   ...
   1000024     4.35648587e+02   # ~chargino(1)
   1000025    -6.83300055e+02   # ~neutralino(3)
   1000035     6.97687129e+02   # ~neutralino(4)
   1000037     6.97783921e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.48879953e-02   # N_{1,2}
  1  3     7.79844337e-02   # N_{1,3}
  1  4    -3.33883707e-02   # N_{1,4}
  2  1     3.44318702e-02   # N_{2,1}
  2  2     9.70437589e-01   # N_{2,2}
  2  3    -1.96384491e-01   # N_{2,3}
  2  4     1.36009061e-01   # N_{2,4}
  3  1    -3.07169681e-02   # N_{3,1}
  3  2     4.43247745e-02   # N_{3,2}
  3  3     7.04050836e-01   # N_{3,3}
  3  4     7.08099006e-01   # N_{3,4}
  4  1    -7.27249736e-02   # N_{4,1}
  4  2     2.36779536e-01   # N_{4,2}
  4  3     6.77985235e-01   # N_{4,3}
  4  4    -6.92085652e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.59530950e-01   # U_{1,1}
  1  2    -2.81603189e-01   # U_{1,2}
  2  1     2.81603189e-01   # U_{2,1}
  2  2     9.59530950e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.80637856e-01   # V_{1,1}
  1  2    -1.95830015e-01   # V_{1,2}
  2  1     1.95830015e-01   # V_{2,1}
  2  2     9.80637856e-01   # V_{2,2}
...
Block hmix Q= 1.21970552e+03 # Higgs mixing parameters
     1     6.75495681e+02    # mu(Q)MSSM DRbar
...
Block au Q= 1.21970552e+03  
  ...
  3  3    -9.41968573e+02      # At(Q)MSSM DRbar
...
Block ae Q= 1.21970552e+03  
  1  1    -3.25453963e+02      # Ae(Q)MSSM DRbar
  2  2    -3.25448206e+02      # Amu(Q)MSSM DRbar
  3  3    -3.23735325e+02      # Atau(Q)MSSM DRbar
