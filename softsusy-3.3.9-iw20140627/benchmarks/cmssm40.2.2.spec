...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.95484140e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=6.15435859e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03905663e+01   # MW
        25     1.17110152e+02   # h0
        35     6.90304463e+02   # H0
        36     6.90308949e+02   # A0
        37     6.95366434e+02   # H+
   1000021     1.17095710e+03   # ~g
   1000022     2.08190368e+02   # ~neutralino(1)
   1000023     3.97021380e+02   # ~neutralino(2)
   1000024     3.97146432e+02   # ~chargino(1)
   1000025    -6.97378958e+02   # ~neutralino(3)
   1000035     7.05939708e+02   # ~neutralino(4)
   1000037     7.07079951e+02   # ~chargino(2)
   1000001     1.20234556e+03   # ~d_L
   1000002     1.19986762e+03   # ~u_L
   1000003     1.20230844e+03   # ~s_L
   1000004     1.19983041e+03   # ~c_L
   1000005     9.90190319e+02   # ~b_1
   1000006     8.35836541e+02   # ~t_1
   1000011     6.86803180e+02   # ~e_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.03720244e-02   # N_{1,2}
  1  3     7.22823046e-02   # N_{1,3}
  1  4    -2.36540191e-02   # N_{1,4}
  2  1     2.44496581e-02   # N_{2,1}
  2  2     9.81284428e-01   # N_{2,2}
  2  3    -1.64907887e-01   # N_{2,3}
  2  4     9.63767299e-02   # N_{2,4}
  3  1    -3.37038527e-02   # N_{3,1}
  3  2     4.95651300e-02   # N_{3,2}
  3  3     7.03696398e-01   # N_{3,3}
  3  4     7.07968027e-01   # N_{3,4}
  4  1    -6.44832350e-02   # N_{4,1}
  4  2     1.85786409e-01   # N_{4,2}
  4  3     6.87307818e-01   # N_{4,3}
  4  4    -6.99237646e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.71990340e-01   # U_{1,1}
  1  2    -2.35020807e-01   # U_{1,2}
  2  1     2.35020807e-01   # U_{2,1}
  2  2     9.71990340e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.90449001e-01   # V_{1,1}
  1  2    -1.37879575e-01   # V_{1,2}
  2  1     1.37879575e-01   # V_{2,1}
  2  2     9.90449001e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     4.28731082e-01   # F_{11}
  1  2     9.03432155e-01   # F_{12}
  2  1     9.03432155e-01   # F_{21}
...
Block staumix               # stau mixing matrix
  1  1     2.91479006e-01   # F_{11}
  1  2     9.56577226e-01   # F_{12}
  2  1     9.56577226e-01   # F_{21}
  2  2    -2.91479006e-01   # F_{22}
Block gauge Q= 9.09330046e+02  # SM gauge couplings
     1     3.62083238e-01   # g'(Q)MSSM DRbar
     2     6.41966864e-01   # g(Q)MSSM DRbar
     3     1.05866877e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.09330046e+02  
  3  3     8.55106943e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.09330046e+02  
  3  3     4.96923620e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.09330046e+02  
  3  3     4.23632990e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.09330046e+02 # Higgs mixing parameters
     1     6.92874162e+02    # mu(Q)MSSM DRbar
     2     3.92246833e+01    # tan beta(Q)MSSM DRbar
     3     2.43967083e+02    # higgs vev(Q)MSSM DRbar
     4     6.09295733e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.09330046e+02  # MSSM DRbar SUSY breaking parameters
     1     2.10820270e+02      # M_1(Q)
     2     3.91199546e+02      # M_2(Q)
     3     1.11446202e+03      # M_3(Q)
    21     6.23650687e+03      # mH1^2(Q)
    22    -4.71933973e+05      # mH2^2(Q)
