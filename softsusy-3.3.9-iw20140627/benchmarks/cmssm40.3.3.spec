...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.16983942e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.16533756e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03920290e+01   # MW
        25     1.16236245e+02   # h0
        35     8.61531996e+02   # H0
        36     8.61649038e+02   # A0
        37     8.65546922e+02   # H+
   1000021     9.89071439e+02   # ~g
   1000022     1.66665507e+02   # ~neutralino(1)
   1000023     3.18506515e+02   # ~neutralino(2)
   1000024     3.18604061e+02   # ~chargino(1)
   1000025    -5.72304370e+02   # ~neutralino(3)
   1000035     5.82855190e+02   # ~neutralino(4)
   1000037     5.84122257e+02   # ~chargino(2)
   ...
   2000005     1.19068070e+03   # ~b_2
   2000006     1.10339988e+03   # ~t_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -1.50008013e-02   # N_{1,2}
  1  3     8.85386082e-02   # N_{1,3}
  1  4    -2.82985699e-02   # N_{1,4}
  2  1     3.52671127e-02   # N_{2,1}
  2  2     9.73576593e-01   # N_{2,2}
  2  3    -1.95743427e-01   # N_{2,3}
  2  4     1.12202318e-01   # N_{2,4}
  3  1    -4.13841901e-02   # N_{3,1}
  3  2     6.10236050e-02   # N_{3,2}
  3  3     7.02059484e-01   # N_{3,3}
  3  4     7.08290865e-01   # N_{3,4}
  4  1    -7.68667536e-02   # N_{4,1}
  4  2     2.19544333e-01   # N_{4,2}
  4  3     6.78938809e-01   # N_{4,3}
  4  4    -6.96371942e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.60183686e-01   # U_{1,1}
  1  2    -2.79369450e-01   # U_{1,2}
  2  1     2.79369450e-01   # U_{2,1}
  2  2     9.60183686e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.87003209e-01   # V_{1,1}
  1  2    -1.60700548e-01   # V_{1,2}
  2  1     1.60700548e-01   # V_{2,1}
...
Block gauge Q= 9.64465708e+02  # SM gauge couplings
     1     3.62031034e-01   # g'(Q)MSSM DRbar
     2     6.42228082e-01   # g(Q)MSSM DRbar
     3     1.05942698e+00   # g3(Q)MSSM DRbar
Block yu Q= 9.64465708e+02  
  3  3     8.57737737e-01   # Yt(Q)MSSM DRbar
Block yd Q= 9.64465708e+02  
  3  3     5.17479727e-01   # Yb(Q)MSSM DRbar
Block ye Q= 9.64465708e+02  
  3  3     4.12655259e-01   # Ytau(Q)MSSM DRbar
Block hmix Q= 9.64465708e+02 # Higgs mixing parameters
     1     5.64441587e+02    # mu(Q)MSSM DRbar
     2     3.92312849e+01    # tan beta(Q)MSSM DRbar
     3     2.43738504e+02    # higgs vev(Q)MSSM DRbar
     4     8.94418841e+05    # mA^2(Q)MSSM DRbar
Block msoft Q= 9.64465708e+02  # MSSM DRbar SUSY breaking parameters
     1     1.68500663e+02      # M_1(Q)
     2     3.13075306e+02      # M_2(Q)
     3     8.93584722e+02      # M_3(Q)
    21     4.44470747e+05      # mH1^2(Q)
    22    -3.06145326e+05      # mH2^2(Q)
    ...
    46     8.71832811e+02      # mtR(Q)
    47     1.32831404e+03      # mdR(Q)
    48     1.32822014e+03      # msR(Q)
    49     1.16645139e+03      # mbR(Q)
Block au Q= 9.64465708e+02  
  1  1    -1.25023378e+03      # Au(Q)MSSM DRbar
  2  2    -1.25020208e+03      # Ac(Q)MSSM DRbar
  3  3    -8.39781748e+02      # At(Q)MSSM DRbar
Block ad Q= 9.64465708e+02  
  1  1    -1.45064481e+03      # Ad(Q)MSSM DRbar
  2  2    -1.45056409e+03      # As(Q)MSSM DRbar
  3  3    -1.19477347e+03      # Ab(Q)MSSM DRbar
Block ae Q= 9.64465708e+02  
  1  1    -5.72726478e+02      # Ae(Q)MSSM DRbar
  2  2    -5.72428071e+02      # Amu(Q)MSSM DRbar
