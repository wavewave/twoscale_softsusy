...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.67790039e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.86750772e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03934019e+01   # MW
        25     1.17043622e+02   # h0
        35     9.77200064e+02   # H0
        36     9.76997029e+02   # A0
        37     9.80509642e+02   # H+
   1000021     1.56472041e+03   # ~g
   1000022     2.91383645e+02   # ~neutralino(1)
   1000023     5.51267892e+02   # ~neutralino(2)
   1000024     5.51360010e+02   # ~chargino(1)
   1000025    -8.53787662e+02   # ~neutralino(3)
   1000035     8.65237448e+02   # ~neutralino(4)
   1000037     8.65433258e+02   # ~chargino(2)
   ...
   1000006     1.10970023e+03   # ~t_1
   1000011     5.01772039e+02   # ~e_L
   1000012     4.95319925e+02   # ~nue_L
   1000013     5.01767549e+02   # ~mu_L
   1000014     4.95315398e+02   # ~numu_L
   ...
   2000006     1.35152698e+03   # ~t_2
   2000011     3.18456782e+02   # ~e_R
   2000013     3.18442490e+02   # ~mu_R
   2000015     5.01770159e+02   # ~stau_2
Block alpha                     # Effective Higgs mixing parameter
          -1.05492023e-01       # alpha
Block nmix                  # neutralino mixing matrix
  1  1     9.97675473e-01   # N_{1,1}
  1  2    -9.67187536e-03   # N_{1,2}
  1  3     6.18931641e-02   # N_{1,3}
  1  4    -2.68205601e-02   # N_{1,4}
  2  1     2.25782535e-02   # N_{2,1}
  2  2     9.80059896e-01   # N_{2,2}
  2  3    -1.61749007e-01   # N_{2,3}
  2  4     1.13181630e-01   # N_{2,4}
  3  1    -2.43764929e-02   # N_{3,1}
  3  2     3.52004347e-02   # N_{3,2}
  3  3     7.05138167e-01   # N_{3,3}
  3  4     7.07776010e-01   # N_{3,4}
  4  1    -5.94950456e-02   # N_{4,1}
  4  2     1.95320209e-01   # N_{4,2}
  4  3     6.87594837e-01   # N_{4,3}
  4  4    -6.96795304e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.73073985e-01   # U_{1,1}
  1  2    -2.30492992e-01   # U_{1,2}
  2  1     2.30492992e-01   # U_{2,1}
  2  2     9.73073985e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.86844830e-01   # V_{1,1}
  1  2    -1.61670289e-01   # V_{1,2}
  2  1     1.61670289e-01   # V_{2,1}
  2  2     9.86844830e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  ...
  1  2     1.72145985e-01   # F_{12}
  2  1    -1.72145985e-01   # F_{21}
...
Block au Q= 1.18926661e+03  
  1  1    -1.54178088e+03      # Au(Q)MSSM DRbar
  2  2    -1.54177406e+03      # Ac(Q)MSSM DRbar
  3  3    -1.19569030e+03      # At(Q)MSSM DRbar
Block ad Q= 1.18926661e+03  
  1  1    -1.87905474e+03      # Ad(Q)MSSM DRbar
  2  2    -1.87904844e+03      # As(Q)MSSM DRbar
  3  3    -1.75759885e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.18926661e+03  
