...
Block EXTPAR               # scale of SUSY breaking BCs
     0    2.21120366e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.24013973e-04
...
# PDG code     mass             particle
        ...
        37     1.01720914e+03   # H+
   1000021     9.76358735e+02   # ~g
   1000022     1.63864556e+02   # ~neutralino(1)
   1000023     3.09431760e+02   # ~neutralino(2)
   1000024     3.09342207e+02   # ~chargino(1)
   1000025    -5.24849854e+02   # ~neutralino(3)
   1000035     5.41079890e+02   # ~neutralino(4)
   1000037     5.41355360e+02   # ~chargino(2)
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -2.54605248e-02   # N_{1,2}
  1  3     1.01462332e-01   # N_{1,3}
  1  4    -4.12150343e-02   # N_{1,4}
  2  1     5.41991855e-02   # N_{2,1}
  2  2     9.60332001e-01   # N_{2,2}
  2  3    -2.29099164e-01   # N_{2,3}
  2  4     1.49460596e-01   # N_{2,4}
  3  1    -4.07308827e-02   # N_{3,1}
  3  2     5.93883456e-02   # N_{3,2}
  3  3     7.01719327e-01   # N_{3,3}
  3  4     7.08804632e-01   # N_{3,4}
  4  1    -8.96937328e-02   # N_{4,1}
  4  2     2.71269671e-01   # N_{4,2}
  4  3     6.66939993e-01   # N_{4,3}
  4  4    -6.88156120e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.43969124e-01   # U_{1,1}
  1  2    -3.30033777e-01   # U_{1,2}
  2  1     3.30033777e-01   # U_{2,1}
  2  2     9.43969124e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.76321649e-01   # V_{1,1}
  1  2    -2.16323918e-01   # V_{1,2}
  2  1     2.16323918e-01   # V_{2,1}
  2  2     9.76321649e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     2.79639568e-01   # F_{11}
  1  2     9.60105053e-01   # F_{12}
  2  1     9.60105053e-01   # F_{21}
  2  2    -2.79639568e-01   # F_{22}
...
Block au Q= 9.06828041e+02  
  1  1    -9.16500908e+02      # Au(Q)MSSM DRbar
  2  2    -9.16496796e+02      # Ac(Q)MSSM DRbar
  3  3    -7.04980032e+02      # At(Q)MSSM DRbar
Block ad Q= 9.06828041e+02  
  1  1    -1.12355710e+03      # Ad(Q)MSSM DRbar
  2  2    -1.12355329e+03      # As(Q)MSSM DRbar
  3  3    -1.04923433e+03      # Ab(Q)MSSM DRbar
Block ae Q= 9.06828041e+02  
  1  1    -2.40109701e+02      # Ae(Q)MSSM DRbar
  2  2    -2.40105371e+02      # Amu(Q)MSSM DRbar
  3  3    -2.38821297e+02      # Atau(Q)MSSM DRbar
