...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=3.58116525e-06
...
# PDG code     mass             particle
   ...
   1000011     3.79310671e+02   # ~e_L
   1000012     3.70629103e+02   # ~nue_L
   1000013     3.79309034e+02   # ~mu_L
   1000014     3.70627434e+02   # ~numu_L
   1000015     1.83227200e+02   # ~stau_1
   1000016     3.69891330e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  4    -6.31592859e-02   # N_{1,4}
  2  1     9.82643484e-02   # N_{2,1}
  2  2     8.72095814e-01   # N_{2,2}
  2  3    -3.76890472e-01   # N_{2,3}
  2  4     2.96220494e-01   # N_{2,4}
  ...
  4  2     4.83678221e-01   # N_{4,2}
  4  3     5.91403418e-01   # N_{4,3}
  4  4    -6.36527090e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     8.37329507e-01   # U_{1,1}
  1  2    -5.46698543e-01   # U_{1,2}
  2  1     5.46698543e-01   # U_{2,1}
  2  2     8.37329507e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.02611277e-01   # V_{1,1}
  1  2    -4.30456598e-01   # V_{1,2}
  2  1     4.30456598e-01   # V_{2,1}
  2  2     9.02611277e-01   # V_{2,2}
...
Block sbotmix               # sbottom mixing matrix
  1  1     4.09291394e-01   # F_{11}
  1  2     9.12403724e-01   # F_{12}
  2  1     9.12403724e-01   # F_{21}
  2  2    -4.09291394e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.01468265e-01   # F_{11}
  1  2     9.94838776e-01   # F_{12}
  2  1     9.94838776e-01   # F_{21}
  2  2    -1.01468265e-01   # F_{22}
...
Block hmix Q= 1.10540107e+03 # Higgs mixing parameters
     1     4.21053589e+02    # mu(Q)MSSM DRbar
...
Block ae Q= 1.10540107e+03  
  1  1    -2.93107144e+01      # Ae(Q)MSSM DRbar
  2  2    -2.93104978e+01      # Amu(Q)MSSM DRbar
  3  3    -2.92442591e+01      # Atau(Q)MSSM DRbar
