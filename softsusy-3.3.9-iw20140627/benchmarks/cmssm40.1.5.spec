...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.67496280e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.20641234e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03883201e+01   # MW
        25     1.18671904e+02   # h0
        35     8.06859144e+02   # H0
        36     8.06862472e+02   # A0
        37     8.11134131e+02   # H+
   1000021     1.57094186e+03   # ~g
   1000022     2.94221540e+02   # ~neutralino(1)
   1000023     5.59328512e+02   # ~neutralino(2)
   1000024     5.59472734e+02   # ~chargino(1)
   1000025    -9.12542040e+02   # ~neutralino(3)
   1000035     9.20022922e+02   # ~neutralino(4)
   1000037     9.20855866e+02   # ~chargino(2)
   1000001     1.47782240e+03   # ~d_L
   1000002     1.47580161e+03   # ~u_L
   1000003     1.47778269e+03   # ~s_L
   1000004     1.47576183e+03   # ~c_L
   1000005     1.25367622e+03   # ~b_1
   1000006     1.08845331e+03   # ~t_1
   1000011     6.10397356e+02   # ~e_L
   1000012     6.04954720e+02   # ~nue_L
   1000013     6.10253014e+02   # ~mu_L
   1000014     6.04809968e+02   # ~numu_L
   1000015     2.93076038e+02   # ~stau_1
   1000016     5.54505500e+02   # ~nu_tau_L
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -6.14398618e-03   # N_{1,2}
  1  3     5.57115047e-02   # N_{1,3}
  1  4    -1.95502143e-02   # N_{1,4}
  2  1     1.53975836e-02   # N_{2,1}
  2  2     9.86734028e-01   # N_{2,2}
  2  3    -1.36975804e-01   # N_{2,3}
  2  4     8.57700444e-02   # N_{2,4}
  3  1    -2.52714799e-02   # N_{3,1}
  3  2     3.67780129e-02   # N_{3,2}
  3  3     7.05185532e-01   # N_{3,3}
  3  4     7.07617196e-01   # N_{3,4}
  4  1    -5.14587012e-02   # N_{4,1}
  4  2     1.58005020e-01   # N_{4,2}
  4  3     6.93431484e-01   # N_{4,3}
  4  4    -7.01098562e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.80820242e-01   # U_{1,1}
  1  2    -1.94914475e-01   # U_{1,2}
  2  1     1.94914475e-01   # U_{2,1}
  2  2     9.80820242e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.92473347e-01   # V_{1,1}
  1  2    -1.22460836e-01   # V_{1,2}
  2  1     1.22460836e-01   # V_{2,1}
  2  2     9.92473347e-01   # V_{2,2}
...
Block gauge Q= 1.16478050e+03  # SM gauge couplings
     ...
     2     6.40796363e-01   # g(Q)MSSM DRbar
...
Block msoft Q= 1.16478050e+03  # MSSM DRbar SUSY breaking parameters
    ...
    21    -1.79446279e+05      # mH1^2(Q)
    22    -8.09970348e+05      # mH2^2(Q)
...
Block ad Q= 1.16478050e+03  
  1  1    -2.17630610e+03      # Ad(Q)MSSM DRbar
  2  2    -2.17619483e+03      # As(Q)MSSM DRbar
  3  3    -1.84323050e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.16478050e+03  
  1  1    -7.06310036e+02      # Ae(Q)MSSM DRbar
  2  2    -7.05970646e+02      # Amu(Q)MSSM DRbar
