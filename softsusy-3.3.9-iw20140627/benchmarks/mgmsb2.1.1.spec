...
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=1.16757920e-04
...
# PDG code     mass             particle
   ...
   1000022     1.14265309e+02   # ~neutralino(1)
   ...
   1000011     2.56424544e+02   # ~e_L
   1000012     2.43498005e+02   # ~nue_L
   1000013     2.56423461e+02   # ~mu_L
   1000014     2.43496869e+02   # ~numu_L
   1000015     1.22808063e+02   # ~stau_1
...
Block nmix                  # neutralino mixing matrix
  ...
  4  2     5.12949091e-01   # N_{4,2}
  4  3     5.64377142e-01   # N_{4,3}
  4  4    -6.32709596e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     7.99953015e-01   # U_{1,1}
  1  2    -6.00062641e-01   # U_{1,2}
  2  1     6.00062641e-01   # U_{2,1}
  2  2     7.99953015e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.00655208e-01   # V_{1,1}
  1  2    -4.34534460e-01   # V_{1,2}
  2  1     4.34534460e-01   # V_{2,1}
  2  2     9.00655208e-01   # V_{2,2}
Block stopmix               # stop mixing matrix
  1  1     3.27995908e-01   # F_{11}
  1  2     9.44679144e-01   # F_{12}
  2  1     9.44679144e-01   # F_{21}
  2  2    -3.27995908e-01   # F_{22}
Block sbotmix               # sbottom mixing matrix
  1  1     5.43483380e-01   # F_{11}
  1  2     8.39419928e-01   # F_{12}
  2  1     8.39419928e-01   # F_{21}
  2  2    -5.43483380e-01   # F_{22}
Block staumix               # stau mixing matrix
  1  1     1.54174028e-01   # F_{11}
  1  2     9.88043708e-01   # F_{12}
  2  1     9.88043708e-01   # F_{21}
  2  2    -1.54174028e-01   # F_{22}
Block gauge Q= 7.68693772e+02  # SM gauge couplings
     1     3.62512223e-01   # g'(Q)MSSM DRbar
     2     6.46107291e-01   # g(Q)MSSM DRbar
...
Block hmix Q= 7.68693772e+02 # Higgs mixing parameters
     1     2.95114946e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 7.68693772e+02  # MSSM DRbar SUSY breaking parameters
     ...
     2     2.29808732e+02      # M_2(Q)
     3     6.41114032e+02      # M_3(Q)
    21     5.42288415e+04      # mH1^2(Q)
    22    -7.85626810e+04      # mH2^2(Q)
...
Block ae Q= 7.68693772e+02  
  ...
  3  3    -1.94367942e+01      # Atau(Q)MSSM DRbar
