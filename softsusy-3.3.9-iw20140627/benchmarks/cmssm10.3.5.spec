...
Block EXTPAR               # scale of SUSY breaking BCs
     0    1.71306929e+16   # MX scale
# SOFTSUSY-specific non SLHA information:
# MIXING=0 Desired accuracy=1.00000000e-03 Achieved accuracy=2.32302729e-04
Block MASS                      # Mass spectrum
# PDG code     mass             particle
        24     8.03926120e+01   # MW
        25     1.17527570e+02   # h0
        35     1.13477668e+03   # H0
        36     1.13455800e+03   # A0
        37     1.13767469e+03   # H+
   1000021     1.68018661e+03   # ~g
   1000022     3.14733797e+02   # ~neutralino(1)
   1000023     5.95354477e+02   # ~neutralino(2)
   1000024     5.95455369e+02   # ~chargino(1)
   1000025    -9.05522746e+02   # ~neutralino(3)
   1000035     9.16744516e+02   # ~neutralino(4)
   1000037     9.16902247e+02   # ~chargino(2)
   1000001     1.59622565e+03   # ~d_L
   1000002     1.59440882e+03   # ~u_L
   1000003     1.59622156e+03   # ~s_L
   1000004     1.59440471e+03   # ~c_L
   1000005     1.45220827e+03   # ~b_1
   1000006     1.21849009e+03   # ~t_1
   1000011     7.07467727e+02   # ~e_L
   1000012     7.02805643e+02   # ~nue_L
   1000013     7.07459919e+02   # ~mu_L
   1000014     7.02797835e+02   # ~numu_L
   1000015     5.66700604e+02   # ~stau_1
   1000016     7.00255718e+02   # ~nu_tau_L
   2000001     1.53218982e+03   # ~d_R
   2000002     1.53794157e+03   # ~u_R
   2000003     1.53218560e+03   # ~s_R
   2000004     1.53793714e+03   # ~c_R
   2000005     1.52483410e+03   # ~b_2
...
Block nmix                  # neutralino mixing matrix
  ...
  1  2    -8.60437443e-03   # N_{1,2}
  1  3     5.86553570e-02   # N_{1,3}
  1  4    -2.57477519e-02   # N_{1,4}
  2  1     2.05343580e-02   # N_{2,1}
  2  2     9.81171335e-01   # N_{2,2}
  2  3    -1.56662020e-01   # N_{2,3}
  2  4     1.11077285e-01   # N_{2,4}
  3  1    -2.29164682e-02   # N_{3,1}
  3  2     3.29880869e-02   # N_{3,2}
  3  3     7.05374243e-01   # N_{3,3}
  3  4     7.07696120e-01   # N_{3,4}
  4  1    -5.68384423e-02   # N_{4,1}
  4  2     1.90106713e-01   # N_{4,2}
  4  3     6.88813282e-01   # N_{4,3}
  4  4    -6.97255399e-01   # N_{4,4}
Block Umix                  # chargino U mixing matrix 
  1  1     9.74640115e-01   # U_{1,1}
  1  2    -2.23778120e-01   # U_{1,2}
  2  1     2.23778120e-01   # U_{2,1}
  2  2     9.74640115e-01   # U_{2,2}
Block Vmix                  # chargino V mixing matrix 
  1  1     9.87244774e-01   # V_{1,1}
  1  2    -1.59209788e-01   # V_{1,2}
  2  1     1.59209788e-01   # V_{2,1}
...
Block staumix               # stau mixing matrix
  1  1     9.29681115e-02   # F_{11}
  1  2     9.95669087e-01   # F_{12}
  2  1     9.95669087e-01   # F_{21}
  2  2    -9.29681115e-02   # F_{22}
...
Block hmix Q= 1.30491909e+03 # Higgs mixing parameters
     1     8.99472089e+02    # mu(Q)MSSM DRbar
...
Block msoft Q= 1.30491909e+03  # MSSM DRbar SUSY breaking parameters
     1     3.19733700e+02      # M_1(Q)
     2     5.87648135e+02      # M_2(Q)
     3     1.62241668e+03      # M_3(Q)
    21     4.50344099e+05      # mH1^2(Q)
    22    -7.71702670e+05      # mH2^2(Q)
    31     7.00513033e+02      # meL(Q)
    32     7.00505177e+02      # mmuL(Q)
    33     6.98127722e+02      # mtauL(Q)
...
Block ad Q= 1.30491909e+03  
  1  1    -1.99454446e+03      # Ad(Q)MSSM DRbar
  2  2    -1.99453780e+03      # As(Q)MSSM DRbar
  3  3    -1.86593337e+03      # Ab(Q)MSSM DRbar
Block ae Q= 1.30491909e+03  
  1  1    -4.40695498e+02      # Ae(Q)MSSM DRbar
  2  2    -4.40687773e+02      # Amu(Q)MSSM DRbar
  3  3    -4.38352543e+02      # Atau(Q)MSSM DRbar
