...
*--> Higgs Potential Couplings
      ...
      do KK=1,4
        write(21,fmt='(A2,I1,2x,1PE16.8)') 'la',KK,LR_H(KK)
      enddo
      do KK=1,3
      write(21,fmt='(A2,I1,A1,2x,1PE16.8)')'la',KK+4,'r',DREAL(LC_H(KK))
      write(21,fmt='(A2,I1,A1,2x,1PE18.8)')'la',KK+4,'i',DIMAG(LC_H(KK))
      enddo
...
C Td3= (\Delat{hd}/hd)*sb/( cb*(1+\delta{hd}/hd) +  sb*\Dealta{hd}/hd )
      ...
      write(21 ,FMT='(A4,2x,1PE16.8)') 'Td3r',DREAL(Td3)
      write(21 ,FMT='(A4,2x,1PE16.8)') 'Td3i',DIMAG(Td3)
...
C Tu3= (\Delat{hu}/hu)*cb/( sb*(1+\delta{hu}/hu) +  cb*\Dealta{hu}/hu )
      ...
      write(21 ,FMT='(A4,2x,1PE16.8)') 'Tu3r',DREAL(Tu3)
      write(21 ,FMT='(A4,2x,1PE16.8)') 'Tu3i',DIMAG(Tu3)
