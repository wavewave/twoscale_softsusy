...
* NOTE: KK=Kappa, K2=Kappa**2
	...
	F(5)= 3.D0*KK*(L2 + K2)
     .	    + c2*KK*(24.D0*K2*(L2 - K2)
     .	    + 6.D0*L2*(g1 + 3.D0*g2 - 2.D0*L2 + 3.D0*HT2 + 3.D0*HB2))/2.
	...
	F(31)=XIS*(L2+K2)+4.D0*MS*KK*MUP
     .        +2.D0*LL*M3SQ*(AL+2.D0*MUP)+2.D0*XIF*(L2*AL+K2*AK)
     .        +2.D0*KK*MST*(AK+2.D0*MUP)
     
        F(32)=2.D0*MUP*(L2+K2)
	
	F(33)=4.D0*MUP*(L2*AL+K2*AK)+2.D0*MST*(L2+2.D0*K2)
     .	      +2.D0*LL*KK*M3SQ
	
	F(34)=M3SQ*(6.D0*L2+3.D0*HT2+3.D0*HB2+HTAU2-G1-3.D0*G2)/2.D0
     .        +2.D0*LL*KK*MST

	F(35)=L2*AL+3.D0*HB2*AB+HTAU2*ATAU
     .	      +3.D0*g1*M1+3.D0*g2*M2
