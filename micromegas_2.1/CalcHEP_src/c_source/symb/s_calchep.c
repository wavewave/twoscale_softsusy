...
/*         " Amplitude calculation" */
         " Squaring technique   ","s_squa_*",&pscr3,&k3);
      switch (k3)
      {
...
label_50:
   ...
   {  int n_calchep_id;   
      ...
      if(k5==1||k5==2)
      {
         ...
         if(n_calchep_id) unLockFile(n_calchep_id);
         else
         {  
      ...
      {  case 0: goto label_40;  break;
         ...
         case 2:
           if(newCodes) 
           {  messanykey(3,10,"You have new diagrams calculated!\n"
                   " Write down 'C code' before launching compiler.");
              break;     
           }
